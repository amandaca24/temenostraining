...
/* global constants */
(function() {
    var $K = kony.$kwebfw$, _cache = {}; //e.g. _cache['image_name.png'] = {path:'', height:-1, width:-1}
        ...
        Image2: function Image2$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Image2', null);
                }
            }
            if(!_.name) {
    ...
    var _view = {
        Image2: {
            base64: function Image2$_view_base64(el, old) {
                ...
                if(this.base64) {
                    $KD.setAttr(el.image, 'src', ('data:image/png;base64,'+this.base64));
    ...
    Object.defineProperty(kony.ui, 'Image2', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Image2 constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Image2>, but not in <_valid.Image2> namespace.');
                        } else {
        ...
        $K.utils.inherits(Image2, kony.ui.BasicWidget);
         ...
         * @access      protected
         * @method      _flush
         * @memberof    kony.ui.Image2
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     void
         */
        var image2__flush = function Image2$_flush() {
            var $super = kony.ui.Image2.base.prototype,
        ...
        /**
         * Builds the view layer for kony.ui.Image2 widget.
         *
         * @override
         * @access      protected
         * @method      _render
        ...
        var image2__render = function Image2$_render(tag) {
            var $super = kony.ui.Image2.base.prototype, _ = this._kwebfw_,
            ...
            if(this.isVisible || $K.F.RIVW) {
                if(!view) {
                    img = $KD.create('IMG');
                    if(this.height !== kony.flex.USE_PREFERRED_SIZE) {
        ...
        $K.defKonyProp(Image2.prototype, [
