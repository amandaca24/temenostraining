...
(function() {
        ...
        Video: function Video$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Video', null);
                }
            }
            if(!_.name) {
        ...
        Video: {
            ...
            source: function Video$_view_source(el, old) {
                ...
                $KU.each(this._kwebfw_.prop.source, function(url, type) {
                    var $K = kony.$kwebfw$, $KD = $K.dom, source = null;
    ...
    Object.defineProperty(kony.ui, 'Video', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Video constructor.
         *
         * @class
         * @namespace   kony.ui
        ...
        var Video = function Video(bconfig, lconfig, pspconfig) {
            ...
            prop = {
                ...
                source: null,
                tracks : null,
                enableCaptions : false // by default enable captions should be false
            };
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Video>, but not in <_valid.Video> namespace.');
                        } else {
        ...
        $K.utils.inherits(Video, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.Video widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.Video
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – Video view.
         */
        var video__render = function Video$_render(tag) {
            var $super = kony.ui.Video.base.prototype, _ = this._kwebfw_,
                view = _.view, $K = kony.$kwebfw$, $KU = $K.utils,
