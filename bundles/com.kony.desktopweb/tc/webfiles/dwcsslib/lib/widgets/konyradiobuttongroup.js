...
(function() {
    ...
    $K.defKonyProp($K.ui, [
        {keey:'RadioButtonGroup', value:{}, items:[
            ...
            {keey:'onKeyDown', value:function(evt) {
                var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom,
                    radiobutton = null, code = evt.keyCode || evt.which;
    ...
    var _getter = {
        RadioButtonGroup: {
            masterData: function RadioButtonGroup$_getter_masterData(value) {
                var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, data = null;
        ...
        RadioButtonGroup: function RadioButtonGroup$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.RadioButtonGroup', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'RadioButtonGroup', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.RadioButtonGroup constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.RadioButtonGroup>, but not in <_valid.RadioButtonGroup> namespace.');
                        } else {
        ...
        $K.utils.inherits(RadioButtonGroup, kony.ui.GroupWidget);


        /**
         * Builds the view layer for kony.ui.RadioButtonGroup widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.RadioButtonGroup
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – SampleWidget view.
         */
        var radiobuttongroup__render = function RadioButtonGroup$_render(tag) {
            var $super = kony.ui.RadioButtonGroup.base.prototype,
        ...
        $K.defKonyProp(RadioButtonGroup.prototype, [
