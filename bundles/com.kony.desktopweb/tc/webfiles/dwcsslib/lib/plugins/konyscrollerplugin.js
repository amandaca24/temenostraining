...
(function() {
    ...
    var _momentum = function(current, last, duration, maxScroll, viewportSize) {
        var $K = kony.$kwebfw$, $KU = $K.utils, prop = _map[this.id], destination = 0,
    ...
    var _onEnd = function(e) {
        var $K = kony.$kwebfw$, $KU = $K.utils, prop = _map[this.id], top = 0, left = 0,
...
//console.error('momentumX:'+JSON.stringify(momentumX) +' :: '+ 'momentumY:'+JSON.stringify(momentumY));
    ...
    var _onKeyDown = function(e) {
        var $K = kony.$kwebfw$, $KU = $K.utils, prop = _map[this.id];
    ...
    var _position = function() {
        var $K = kony.$kwebfw$, $KU = $K.utils, prop = _map[this.id], top = 0,
    ...
    var _stop = function() {
        var $K = kony.$kwebfw$, $KU = $K.utils, prop = _map[this.id], position = null;
    ...
    kony.$kwebfw$.plugins.Scroller = function(target, left, top, config) {
    ...
    kony.$kwebfw$.plugins.Scroller.prototype = {
...
console.error(e.type);
        ...
        refresh: function() {
            var $K = kony.$kwebfw$, $KD = $K.dom, prop = _map[this.id];
