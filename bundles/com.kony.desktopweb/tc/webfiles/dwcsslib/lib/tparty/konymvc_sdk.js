...
_kony = _kony || {};
_kony.mvc = _kony.mvc || {};
Object.defineProperty(_kony, "def", {
    configurable: false,
    enumerable: false,
    writable: true,
    value: function () {
...
(function () {
    ...
    var _appManager = function () {
        var _ns = {};
        _kony.def(_ns, "getCurrentAppContext", _getCurrentAppData);
        _kony.def(_ns, "setAppContext", _setAppData);
        _kony.def(_ns, "getCurrentAppName", _getCurrentAppName);
        _kony.def(_ns, "isCompositeApp", _kony.mvc.isCompositeApp);
        return _ns
    };
    Object.defineProperty(kony.mvc, "getApplicationManager", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
    ...
    _kony.def(_kony.mvc, "setCurrentAppName", _setCurrentAppName);
    _kony.def(_kony.mvc, "getCurrentAppName", _getCurrentAppName);
    _kony.def(_kony.mvc, "getAppData", _getAppData)
})();
kony.mvc = kony.mvc || {};
...
(function () {
    ...
    var _initializeRuntimeRegistries = function (isCompositeFlag) {
        ...
        if (appConfig) {
            if (appConfig.appName) {
                _kony.mvc.setCurrentAppName(appConfig.appName);
        ...
        _kony.mvc.initializeRegistries(_tmAppsList, _isCompositeApp)
    };
    _kony.def(_kony.mvc, "getAppsList", function () {
        return _tmAppsList
    });
    Object.defineProperty(_kony.mvc, "initCompositeApp", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(_kony.mvc, "isCompositeApp", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
    ...
    _kony.mvc.getViewId2ControllerNameMap = function (appName) {
        var ret;
        if (_isCompositeApp) {
            appName = appName || _kony.mvc.getCurrentAppName();
            ret = _viewId2ControllerNameMap[appName]
        }
        return ret || _viewId2ControllerNameMap
    };
    _kony.mvc.getControllerName2ControllerMap = function (appName) {
        var ret;
        if (_isCompositeApp) {
            appName = appName || _kony.mvc.getCurrentAppName();
    ...
    _kony.mvc.getViewName2viewIdMap = function (appName) {
        var ret;
        if (_isCompositeApp) {
            appName = appName || _kony.mvc.getCurrentAppName();
    ...
    _kony.mvc.getPath = function (fileName, appName) {
    ...
    _kony.mvc.getNameSpacedValue = function (fileName, appName) {
        if (_isCompositeApp) {
            if (!appName)
    ...
    var _getResolvedFilePath = function (fileName, appName) {
        var navConfig,
        path = _kony.mvc.getPath(fileName, appName);
    ...
    _kony.mvc.getControllerFromViewID = function (viewID, appName) {
    ...
    Object.defineProperty(kony.mvc, "resolveNameFromContext", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
            return function (configObj) {
                ...
                if (typeof configObj === "object" && configObj.appName && configObj.friendlyName) {
                    ...
                    if (!_kony.mvc.getFormRegistryInfo(friendlyName, appName)) {
    ...
    Object.defineProperty(_kony.mvc, "navigate", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
            return function (idOrPath, appName) {
                var friendlyName,
                deeplinkFormNav,
                navConfig = _getResolvedNameFromMap(idOrPath);
                if (!navConfig) {
                    navConfig = idOrPath;
                ...
                deeplinkFormNav = new kony.mvc.Navigation(navConfig);
                deeplinkFormNav.navigate()
            }
        }
        ()
    });
    _kony.mvc.initializeSubViewController = function (nameOrPath, appName) {
        var appName = appName || _kony.mvc.getCurrentAppName(),
        ...
        tmpController = _kony.mvc.GetController(friendlyName, false, {
            appName: appName
        });
        return tmpController.view
    };
    _kony.mvc.initializeFormViewController = function (nameOrPath) {
        ...
        tmpController = _kony.mvc.GetController(friendlyName, true, {
            appName: appName
        });
        return tmpController.view
    };
    ...
    _kony.def(_kony.mvc, "getComponentController", function (controllerID, appName) {
    ...
    var _webHotReload = {
        deleteRuntimeRegistries: function (formID, appName) {
            ...
            if (!appConfig.hotReloadURL)
                throw new Error("This API not supported !!!");
            if (appConfig.isDebug) {
                ...
                registryInfo = _kony.mvc.getFormRegistryInfo(friendlyName, appName);
                if (registryInfo) {
    ...
    _kony.def(_kony.mvc, "resetBookKeepersAndGetFormInfo", function (formID, appName) {
...
kony.mvc.FormController = function () {
        ...
        this.__initializeView = function (objController) {
            ...
            if (Object.prototype.hasOwnProperty.call(this, "onCreateView")) {
                ...
                if (typeof viewFileName === "object" && Object.prototype.hasOwnProperty.call(viewFileName, "id")) {
                    ...
                    var path = _kony.mvc.getPath(viewFileName, objController.appName);
                    formCreateFunc = kony.utils.LoadJSFile(path);
                    if (!formCreateFunc) {
            ...
            ctrlName2ControllerMap[retForm._konyControllerName] = objController;
    ...
    FormController.prototype.getPreviousFormFriendlyName = function () {
        ...
        if (null != prevForm) {
            var appName = _kony.mvc.getCurrentAppName();
            var controller = _kony.mvc.getControllerFromViewID(prevForm.id, appName);
            var fName = kony.mvc.registry.getFriendlyName(controller.viewId, appName);
            if (null != fName)
                return fName;
            else
                return prevForm.id
    ...
    FormController.prototype.getCurrentFormFriendlyName = function () {
        var currForm = kony.application.getCurrentForm();
        var appName = _kony.mvc.getCurrentAppName();
        var controller = _kony.mvc.getControllerFromViewID(currForm.id, appName);
        var fName = kony.mvc.registry.getFriendlyName(controller.viewId, appName);
        if (null != fName)
            return fName;
        else
    ...
    FormController.prototype.executeOnAppLevelWidget = function (paramsObject) {
        ...
        var appName = _kony.mvc.getCurrentAppName();
        var tmpWidgetName = kony.mvc.registry.get(widgetName, appName);
        if (null != tmpWidgetName) {
            widgetName = tmpWidgetName
        }
        var controller = _kony.mvc.appLevelWidget2Controller[widgetName];
...
_kony.mvc.formNavigateCounter = 0;
_kony.mvc.viewName2viewId = {};
_kony.mvc.appLevelWidget2Controller = {};
...
kony.mvc.isControllerAvailable = function (formFriendlyName) {
    var ctrlName = null,
    tmpFormName = null,
...
kony.application.setAppLevelWidget = function (paramsObject) {
    ...
    if (typeof widget === "string" || widget instanceof String) {
        var tmpWidget = kony.mvc.registry.get(widget, appName);
        if (null != tmpWidget) {
            widget = tmpWidget
        }
        var controller = _kony.mvc.appLevelWidget2Controller[widget];
        var view;
        if (controller == null || controller == undefined) {
            if (!kony.mvc.registry.getFriendlyName(widget, appName)) {
                return 8004
            }
            view = _kony.mvc.initializeSubViewController(widget, appName);
            controller = ctrlName2ControllerMap[view._konyControllerName];
            _kony.mvc.appLevelWidget2Controller[widget] = controller;
            controller.executeOnCurrentForm = function (paramsObject) {
                ...
                var currentFormControllerName = kony.application.getCurrentForm()._konyControllerName;
                var currentFormController = ctrlName2ControllerMap[currentFormControllerName];
                if (Object.prototype.hasOwnProperty.call(currentFormController, paramsObject.eventName))
                    return currentFormController[paramsObject.eventName].call(currentFormController, paramsObject.params);
                return false
            }
        } else {
    ...
    return _kony.mvc.setAppLevelWidget(paramsObject)
};
kony.application.destroyForm = function (params) {
    ...
    var viewName2viewId = _kony.mvc.getViewName2viewIdMap(appName);
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
    var viewId2ControllerNameMap = _kony.mvc.getViewId2ControllerNameMap(appName);
...
_kony.mvc.destroyController = function (konyControllerName) {
    var tmpController = null;
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap();
    if (konyControllerName in ctrlName2ControllerMap) {
        tmpController = ctrlName2ControllerMap[konyControllerName];
        if (null != tmpController) {
            tmpController.destroy()
        }
        tmpController = null;
        delete ctrlName2ControllerMap[konyControllerName]
    }
};
_kony.mvc.executeInJsContext = function (templateView, functionName, subargs) {
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap();
    if (templateView._konyControllerName in ctrlName2ControllerMap) {
...
_kony.mvc.GetControllerAsync = function (formFriendlyName, context, successCallBack, errorCallback) {
    var tmpController = null,
    ctrlName = null,
    levels = null,
    i = 0,
    ...
    if (null != formID) {
        if (formID in viewId2ControllerNameMap) {
            ...
            requireFileList = [];
            tmpControllerName = kony.mvc.registry.getControllerName(formFriendlyName, appName);
            controllerType = kony.mvc.registry.getControllerType(formFriendlyName, appName);
            controllerTypeFile = kony.mvc.registry.getControllerTypeFile(formFriendlyName, appName);
            extensionControllersList = kony.mvc.registry.getControllerExtName(formFriendlyName, appName);
            if (null == tmpControllerName) {
                tmpControllerName = formID + "Controller"
            }
            requireFileList.push(_kony.mvc.getPath(tmpControllerName, appName));
                ...
                if (typeof extensionControllersList === "string") {
                    ...
                    for (i = 0; i < levels; i++) {
                        if (null != extensionControllersList[i]) {
                            requireFileList.push(_kony.mvc.getPath(extensionControllersList[i], appName))
                        } else {
                            break
                        }
                    }
            ...
            requireFileList.push(_kony.mvc.getPath(formID, appName));
            require(requireFileList, function (config) {
                var ctor = null;
                if (null == controllerType) {
                    tmpController = new kony.mvc.FormController(formName)
                } else {
...
_kony.mvc.GetController = function (formFriendlyName, isForm, metaObj) {
    if (!metaObj) {
        metaObj = {
            appName: _kony.mvc.getCurrentAppName()
        }
    }
    var tmpController = _kony.mvc.GetControllerWithoutView(formFriendlyName, isForm, metaObj);
    var x = tmpController.view;
    return tmpController
};
_kony.mvc.GetControllerWithoutView = function (formFriendlyName, isForm, metaObj) {
    var tmpController = null;
    ...
    if (null != formID) {
        if (isForm && formID in viewId2ControllerNameMap) {
            ...
            var tmpControllerName = kony.mvc.registry.getControllerName(formFriendlyName, appName);
            if (null == tmpControllerName) {
                tmpControllerName = formID + "Controller"
            }
            var path = _kony.mvc.getPath(tmpControllerName, appName);
            var config = kony.utils.LoadJSFile(path);
            if (isForm) {
                var controllerType = kony.mvc.registry.getControllerType(formFriendlyName, appName);
                if (null == controllerType) {
                    tmpController = new kony.mvc.FormController(formName)
                } else {
                    var controllerTypeFile = kony.mvc.registry.getControllerTypeFile(formFriendlyName, appName);
                ...
                var controllerType = kony.mvc.registry.getControllerType(formFriendlyName, appName);
                if (null == controllerType) {
                    tmpController = new kony.mvc.TemplateController(formName)
                } else {
                    var controllerTypeFile = kony.mvc.registry.getControllerTypeFile(formFriendlyName, appName);
                    var controllerTypePath = null;
                    if (null == controllerTypeFile) {
...
_kony.mvc.loadAllExtensionControllers = function (tmpController, config, friendlyName) {
    var controllers = [];
    controllers.push(config);
    var config2 = {};
    var appName = tmpController.appName;
    var tmpControllerName2 = kony.mvc.registry.getControllerExtName(friendlyName, appName);
            ...
            for (var i = 0; i < levels; i++) {
                if (null != tmpControllerName2[i]) {
                    if (tmpController.masterType) {
                        ...
                        path = _kony.mvc.getPath(tmpControllerName2[i], appName)
                    }
                    config2 = kony.utils.LoadJSFile(path);
                    controllers.push(config2)
                } else {
                    break
                }
...
_kony.mvc.CreateMasterWidgetController = function (userWidgetName, uwInstanceName, args) {
    ...
    if (null != formID) {
        var tmpControllerName = kony.mvc.registry.getControllerName(userWidgetName, appName);
        if (null == tmpControllerName) {
            tmpControllerName = formID + "Controller"
        }
        var uwPath = userWidgetName.replace(/\./g, "/");
        var config = kony.utils.LoadJSFile(uwPath + "/" + tmpControllerName);
        var controllerType = kony.mvc.registry.getControllerType(userWidgetName, appName);
        if (null == controllerType) {
...
_kony.mvc.getClonedController = function (templateView) {
    var appName = templateView.appName || _kony.mvc.getCurrentAppName();
    var tmpController = _kony.mvc.GetControllerWithoutView(templateView.id, false, {
        appName: appName
    });
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
...
_kony.mvc.getClonedMasterController = function (masterView) {
    var appName = masterView.appName || _kony.mvc.getCurrentAppName();
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
    var tmpController = ctrlName2ControllerMap[masterView._konyControllerName];
    var tmpController = _kony.mvc.CreateMasterWidgetController(tmpController.userWidgetName, tmpController.viewId, {
...
_kony.mvc.bindController = function (masterView) {
    var appName = masterView.appName || _kony.mvc.getCurrentAppName();
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
    var tmpController = ctrlName2ControllerMap[masterView.controller.Name];
    tmpController.view = masterView;
    masterView._konyControllerName = tmpController.Name;
    tmpController.onDestroy = null
};
_kony.mvc.bindMasterController = function (userwidget, masterView, controllerName) {
    var appName = userwidget.appName || _kony.mvc.getCurrentAppName();
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
    var tmpController = ctrlName2ControllerMap[controllerName];
    masterView._konyControllerName = tmpController.Name;
    userwidget._konyControllerName = tmpController.Name;
    tmpController.view = masterView;
    userwidget._konyInitialized = false;
    if (tmpController.initializeProperties) {
        tmpController.initializeProperties()
    }
    _kony.mvc.setMasterContract(userwidget);
    tmpController.onDestroy = null
};
_kony.mvc.setMasterContract = function (userWidgetInstance) {
    ...
    var appName = userWidgetInstance.appName || _kony.mvc.getCurrentAppName();
    var ctrlName2ControllerMap = _kony.mvc.getControllerName2ControllerMap(appName);
...
_kony.mvc.setProperties = function (userWidgetInstance, properties, tmpController) {
    if (null == properties || null == userWidgetInstance || null == tmpController)
        return;
    if (userWidgetInstance === tmpController)
        return;
    ...
    function Navigation(formname, objModel) {
        ...
        if (typeof formname == "object") {
            ...
            if (formname.appName != appName) {
                ...
                _kony.mvc.setCurrentAppName(appName)
            }
        } else {
        ...
        this.navigate = function (param) {
            ...
            if (_kony.mvc.isSyncLoad()) {
                var controller = _kony.mvc.GetController(formFriendlyName, true, context);
                if (!controller) {
                    kony.print("########## No controller is found to navigate for form " + formFriendlyNamePath);
                    throw "Controller Not Found"
                }
                if (null == model) {
                    if (controller.getModel)
                ...
                var len = _kony.mvc.formNavigateInProgress.length;
                if (len == 0) {
                    _kony.mvc.formNavigateCounter = 0
                } else {
                    _kony.mvc.formNavigateCounter++
                }
                _kony.mvc.formNavigateInProgress.push("Form" + _kony.mvc.formNavigateCounter);
                if (_kony.mvc.formNavigateCounter == 0) {
                    navigateCallback(formFriendlyName, param, _kony.mvc.formNavigateCounter, context)
                } else {
                    scheduleNavigateTimer(formFriendlyName, param, _kony.mvc.formNavigateCounter, context)
                }
            }
        };
        ...
        var navigateCallback = function (formFriendlyName, param, navigateCounter, context) {
            _kony.mvc.GetControllerAsync(formFriendlyName, context, function (controller) {
                var index;
                if (!controller) {
...
(function () {
    ...
    var _loader = {
        ...
        asyncLoad: function (controllerFile, modelFile, config) {
            ...
            require([controllerFile, modelFile], function (controller, model) {
                ...
                kony.print("Fail to load navigation manager for " + self.appName)
            })
        },
    ...
    var _conditions = {
        applicationPreconditionsValidator: function (targetFormInfo) {
            ...
            if (Array.isArray(preConditions) && preConditions.length > 0) {
                targetAppData = _kony.mvc.getAppData(targetFormInfo.appName);
        ...
        isValidCBFormOnTargetFormsConfig: function (targetFormInfo, targetFormsList) {
            ...
            flag = false,
            len = 0;
            if (Array.isArray(targetFormsList))
                len = targetFormsList.length;
            for (i = 0; !flag && i < len; i++) {
    ...
    var _navManager = {
        userNavigate: function (config) {
            ...
            if (targetFormInfo.appName === _kony.mvc.getCurrentAppName()) {
                _navManager.targetFormNavigate.call(this, targetFormInfo)
            } else {
                var appsList = _kony.mvc.getAppsList();
        ...
        appPreConditions: function (targetFormInfo) {
            ...
            if (!isPassed)
                throw new Error("Application preConditions not met.");
            _navManager.targetFormNavigate.call(this, targetFormInfo)
        },
        ...
        getApplicationPrecondtions: function (targetFormInfo) {
            ...
            ret = null;
            if (application)
                ret = application.preConditionConfig;
            return ret
        },
        getFormPrecondtions: function (targetFormInfo) {
            ...
            ret = null;
            if (forms)
                formConfig = forms[targetFormInfo.friendlyName];
            if (formConfig)
                ret = formConfig.preConditionConfig;
            return ret
        },
        targetFormNavigate: function (targetFormInfo) {
            ...
            if (!isPassed)
                throw new Error("Mandatory params not passed to Target Form.");
            targetFormInfo.params = null;
            manager = new kony.mvc.Navigation(targetFormInfo);
    ...
    var _sourceConfig = {
        getUserDestinationConfig: function (context) {
            ...
            if (context instanceof kony.mvc.FormController) {
                tempObj = this._.model.Forms
            } else {
                tempObj = this._.model.UIModules
            }
            if (tempObj)
                destinations = tempObj[context.formFriendlyName];
            if (destinations)
                destinationConfig = destinations.destinationConfig;
            return destinationConfig
        },
        isValidateUserContext: function (context) {
            var flag = false;
            if (context instanceof kony.mvc.FormController || context instanceof kony.mvc.Presentation.BasePresenter) {
                flag = true
            }
            return flag
        },
        getTargetFormInfo: function (destinationConfig, navConfig) {
            ...
            targetFormInfo.appName = targetFormInfo.appName || _kony.mvc.getCurrentAppName();
    ...
    var _navigate = function (config) {
        ...
        if (!flag)
            throw new Error("Invalid Context Param passed to navigate.");
        if (_navigationManagerMap[this.appName]) {
    ...
    _kony.def(NavigationManager.prototype, "navigate", _navigate);
    Object.defineProperty(kony.mvc, "getNavigationManager", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
    ...
    var _isSyncLoad = function () {
        var sync;
        if (_isSyncFlow === null) {
            sync = kony.application.getApplicationBehavior("FormControllerSyncLoad");
            if (undefined === sync || null === sync || sync)
                _isSyncFlow = true;
            else
                _isSyncFlow = false
        }
    ...
    Object.defineProperty(_kony.mvc, "isSyncLoad", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: function () {
    ...
    this.__initializeView = function (objController) {
        ...
        if (Object.prototype.hasOwnProperty.call(this, "onCreateView")) {
            ...
            if (typeof viewFileName === "object" && Object.prototype.hasOwnProperty.call(viewFileName, "id")) {
                ...
                var formCreateFunc = kony.utils.LoadJSFile(viewFileName);
                retForm = formCreateFunc(objController)
            } else {
...
(function () {
    ...
    _kony.def(_kony.mvc, "initializeRegistries", _initializeRegistries);
    var _getRegistryFromObject = function (context) {
        ...
        if (_isCompositeApp) {
            ...
            if (!_ret)
                throw new Error("Invalid entry in registry add API.")
        }
    ...
    var _getFormRegistryInfo = function (friendlyName, appName) {
        var _ret,
        registryMap = _getRegistry(appName),
        formProps = registryMap[friendlyName];
        if (formProps)
            _ret = formProps;
        return _ret
    };
    _kony.def(_kony.mvc, "getFormRegistryInfo", _getFormRegistryInfo);
    kony.mvc.registry.add = function (friendlyName, formid, formCtrllrName, contextORcontrollerExtName) {
        ...
        if (friendlyName in registryMap) {
            ...
            if (typeof formCtrllrName === "string") {
                ...
                if (typeof contextORcontrollerExtName === "string")
                    formProps["controllerExtName"] = contextORcontrollerExtName
            } else {
    ...
    kony.mvc.registry.remove = function (friendlyName, context) {
    ...
    kony.mvc.registry.get = function (friendlyName, appName) {
    ...
    kony.mvc.registry.getFriendlyName = function (formID, appName) {
        var registryMap = _getRegistry(appName);
    ...
    kony.mvc.registry.getControllerName = function (friendlyName, appName) {
        var registryMap = _getRegistry(appName);
        if (friendlyName in registryMap) {
            var formProps = registryMap[friendlyName];
            if (null != formProps) {
    ...
    kony.mvc.registry.getControllerType = function (friendlyName, appName) {
        var registryMap = _getRegistry(appName);
        if (friendlyName in registryMap) {
            var formProps = registryMap[friendlyName];
            if (null != formProps) {
    ...
    kony.mvc.registry.getControllerTypeFile = function (friendlyName, appName) {
        var registryMap = _getRegistry(appName);
        if (friendlyName in registryMap) {
            var formProps = registryMap[friendlyName];
            if (null != formProps) {
    ...
    kony.mvc.registry.getControllerExtName = function (friendlyName, appName) {
        var registryMap = _getRegistry(appName);
        if (friendlyName in registryMap) {
            var formProps = registryMap[friendlyName];
            if (null != formProps) {
...
kony.model.BaseModel = function () {
    function BaseModel(applicationContext, entityMetaData, configOptions) {
        ...
        this.getAccessType = function () {
            if (options && options.hasOwnProperty("access") && options.access.toLowerCase() === "offline")
                return "offline";
            else
                return "online"
        };
