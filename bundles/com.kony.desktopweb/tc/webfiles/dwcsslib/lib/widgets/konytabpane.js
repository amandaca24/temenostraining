...
(function() {
    ...
    $K.defKonyProp($K.ui, [
        {keey:'TabPane', value:{}, items:[
            {keey:'onTabClick', value:function(evt) {
                var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, pos = 0,
    ...
    var _addTab = function TabPane$_addTab(tabId, tabName, tabImage, tabContainer, index, tpl) {
        ...
        if($KU.is(this[tabId], 'widget')) {
            ...
            if($KU.is(tabContainer, 'string')) {
                tabContainer = _kony.mvc.initializeSubViewController(tabContainer);
            }
            ...
            if($KU.is(tabContainer, 'widget', 'FlexContainer')) {
                ...
                $KW.iterate(tabContainer, function(widget) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, _ = widget._kwebfw_;
    ...
    var _flushTabs = function TabPane$_flushTabs(tabs, keepHierarchy) {
        ...
        if($KU.is(tabs, 'array')) {
            $KU.each(tabs, function(tab) {
                ...
                && this[tab.id] instanceof kony.ui.FlexContainer) {
    ...
    var _getIndexByTabId = function TabPane$_getIndexByTabId(tabId) {
        var $K = kony.$kwebfw$, $KU = $K.utils, _ = this._kwebfw_, index = -1;
    ...
    var _handleViewReflection = function TabPane$_handleViewReflection() {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW, $KD = $K.dom, $KW = $K.widget,
        ...
        TabPane: function TabPane$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.TabPane', null);
                }
            }
            if(!_.name) {
    ...
    var _removeTabFromView = function TabPane$_removeTabFromView(index) {
        var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, tab = null,
    ...
    //This function has to be moved to konyui
    ...
    var _view = {
        TabPane: {
            ...
            viewConfig: function TabPane$_view_viewConfig(el, old) {
                var $K = kony.$kwebfw$, $KD = $K.dom, $KU = $K.utils, li = null,
            ...
            viewType: function TabPane$_view_viewType(el, old) {
                ...
                if(prop.viewType !== old) {
                    ...
                    if(old === constants.TABPANE_VIEW_TYPE_TABVIEW) {
                        $KU.each(_.tabs, function(tab, index) {
                            var $K = kony.$kwebfw$, $KD = $K.dom, a = 0, alen = 0,
                        ...
                        $KU.each(_.tabs, function(tab, index) {
                            var $K = kony.$kwebfw$, $KD = $K.dom, a = 0,
    ...
    Object.defineProperty(kony.ui, 'TabPane', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.TabPane constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.TabPane>, but not in <_valid.TabPane> namespace.');
                        } else {
        ...
        $K.utils.inherits(TabPane, kony.ui.BasicWidget);
         ...
         * @access      protected
         * @method      _flush
         * @memberof    kony.ui.TabPane
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     void
         */
        var tabpane__flush = function TabPane$_flush() {
            var $super = kony.ui.TabPane.base.prototype;
        ...
        /**
         * Builds the view layer for kony.ui.TabPane widget.
         *
         * @override
         * @access      protected
         * @method      _render
        ...
        var tabpane__render = function TabPane$_render(tag) {
            var $super = kony.ui.TabPane.base.prototype, _ = this._kwebfw_,
        ...
        var tabpane_addTab = function TabPane$addTab(tabId, tabName, tabImage, tabContainer) {
            var $K = kony.$kwebfw$, $KU = $K.utils, _ = this._kwebfw_, headtemp = null;
        ...
        $K.defKonyProp(TabPane.prototype, [
