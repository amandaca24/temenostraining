...
(function() {
    ...
    //*/
    var $K = kony.$kwebfw$, $KD = $K.dom, body = KD.body(), touchStartFired = false;

    $KD.on(body, ['mousedown', 'touchstart'], 'tapgesture', function(evt) {
        var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, $KA = $K.app,
            target = null, model = null, moveEvent = '', endEvent = '';
...
Object.defineProperty(kony.$kwebfw$, 'gesture', {configurable:false, enumerable:false, writable:false, value:(function() {
