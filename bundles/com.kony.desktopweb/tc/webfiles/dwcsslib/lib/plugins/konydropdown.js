...
(function() {
    var _default = {
        ...
        searchCritaria: kony.$kwebfw$.constants.STARTS_WITH,
        icon: 'kdropdownicon.png',
        position: kony.$kwebfw$.constants.POSITION_AUTO,
        height: '200px',
        selectedOption: '',
        callback: null,
        selectedSkin: '-kony-selected',
        hoverSkin: '-kony-hovered',
        focusSkin: '-kony-focused'
    },

    _map = {}

    var _attachEvents = function() {
        var $K = kony.$kwebfw$, $KD = $K.dom, instance = _map[this.id];
    ...
    _setPosition = function() {
        var $K = kony.$kwebfw$, $KD = $K.dom, constants = kony.$kwebfw$.constants,
    ...
    _getSelectedNode = function(txt) {
        var $K = kony.$kwebfw$, $KD = $K.dom, $KU=$K.utils, instance = _map[this.id], selectedNode = null;
   ...
   _listOnHover = function(e) {
        var $K = kony.$kwebfw$, $KD = $K.dom, instance = _map[this.id], target = e.target,
    ...
    kony.$kwebfw$.plugins.DropDown = function(data, config) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom, prop = null;
    ...
    kony.$kwebfw$.plugins.DropDown.prototype = {
        ...
        init: function() {
            var $K = kony.$kwebfw$, $KD = $K.dom, $KU = $K.utils,
                constants = kony.$kwebfw$.constants, instance = _map[this.id];
