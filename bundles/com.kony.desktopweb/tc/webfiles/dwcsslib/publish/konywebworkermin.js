/* FILE PATH :: 'lib/utils/konyutils.js' */
/* global kony */
/* global navigator */
/* global Bluetooth */
/* global USB */
/* global Clipboard */
/* global NetworkInformation */
/* global Geolocation */
...
Object.defineProperty(kony.$kwebfw$, 'utils', {configurable:false, enumerable:false, writable:false, value:(function() {
            ...
            widget: function(datatype, obj, arg2) {
                if(datatype !== 'widget') {
                    ...
                    if(!arg2) { //arg2 is expected to be a "string"
                        ...
                        && !obj.hasOwnProperty('__$kwebfw$ns__')
                        && !obj.hasOwnProperty('__$kwebfw$name__')) {
                            return true;
                        } else {
                            return false;
                        }
    ...
    var _convertPlainObjectToWidgetInstance = function $KU_convertPlainObjectToWidgetInstance(obj) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, c = 0,
    ...
    var _convertWidgetInstanceToPlainObject = function $KU_convertWidgetInstanceToPlainObject(widget, prefix) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, _ = widget._kwebfw_,
    ...
    var _deduceEscapeProperties = function $KU_deduceEscapeProperties(widget) {
        ...
        escapeProps.push('parent', 'frame', '_konyControllerName');
    ...
    var _deserializeFunction = function $KU_deserializeFunction(value) {
        //*
        var $K = kony.$kwebfw$, $KU = $K.utils, fn = null, name = '', args = '', body = '';
        ...
        /*
        var $K = kony.$kwebfw$, $KU = $K.utils, regexp = '', fn = '', matches = null, name = '', args = '', body = '';
    ...
    var _isDateString = function $KU_isDateString(value) {
        var $K = kony.$kwebfw$, $KU = $K.utils, isValid = false, regexp = null;
    ...
    var _isFunctionString = function $KU_isFunctionString(value) {
        var $K = kony.$kwebfw$, $KU = $K.utils, isValid = false;
    ...
    var _isWidgetString = function $KU_isWidgetString(value) {
        ...
        if(value.substr(0, 21) === 'kony.ui.BasicWidget({'
    ...
    var _serializeDate = function $KU_serializeDate(value) {
        var $K = kony.$kwebfw$, $KU = $K.utils, yyyy = '', mm = '', dt = '', hr = '', min = '', sec = '';
    ...
    var _serializeWidget = function $KU_serializeWidget(value) {
        ...
        return (value) ? ('kony.ui.BasicWidget(' + JSON.stringify(value) + ')') : '';
    };
    ...
    var _browser = function $KU_browser(info, supports) {
        ...
        if(info === 'orientation') {
            ...
            if(!__browser.hasOwnProperty(info)) {
                os = _browser('os');
            ...
            if(supports === 'cookies') {
                if(!__browser[info].hasOwnProperty(supports)) {
    ...
    var _clone = function $KU_clone(obj, prefix) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, type = '';
    ...
    var _copy = function $KU_copy(obj) {
        if(_is(obj, 'array')) {
            ...
            return function() {obj.apply(obj, arguments);};
    ...
    var _datatype = function $KU_datatype(obj, arg1) {
        var objStr = '';
        if((kony.ui.BasicWidget && obj instanceof kony.ui.BasicWidget)
        || (kony.ui.UserWidget && obj instanceof kony.ui.UserWidget)) {
            return 'widget';
        } else {
    ...
    var _each = function $KU_each(variable, callback, scope) {
        ...
        if(_is(variable, 'list')) {
            ...
            for(k in variable) {if(variable.hasOwnProperty(k)) {
                if(arguments.length === 3) {
    ...
    var _error = function KonyError(errorcode, name, message) {
    ...
    */
    ...
    var _getThemeStyleSheet = function $KU_getThemeStyleSheet(identifier) {
        var $K = kony.$kwebfw$, $KU = $K.utils, stylesheet = null;
    ...
    var _getValueUnitByWidgetFrame = function $KU_getValueUnitByWidgetFrame(value, axis, widgetFrame) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KF = kony.flex,
            len = 0, unit = null;
    ...
    var _log = function $KU_log(meta, arg1) {
        var $K = kony.$kwebfw$, $KA = $K.app, msg = '';

        if(_is(meta, 'object') && meta.hasOwnProperty('api')
        && (meta.hasOwnProperty('enter')
        || meta.hasOwnProperty('exit')
        || meta.hasOwnProperty('params'))) {
    ...
    var _set = function $KU_set(key, value, root) {
        ...
        if(_is(key, 'array') && _is(root, 'object')) {
            ...
            if(_is(value, 'object')) {
                if(!value.hasOwnProperty(key[klen])) {
...
(function() {
    ...
    var _convertToRawBytes = function kony_convertToRawBytes(base64String) {
        var $K = kony.$kwebfw$, $KU = $K.utils;
    ...
    var _getError = function kony_getError(error) {
        var $K = kony.$kwebfw$, $KU = $K.utils;
    ...
    var _screenshot = function kony_screenshot(config) {
...
/* FILE PATH :: 'lib/apis/konyapplication.js' */
/* global kony */
/* global constants */
Object.defineProperty(kony, 'application', {configurable:false, enumerable:false, writable:false, value:(function() {
    ...
    var _addBMState = function $KAPP_addBMState(formId, keey, value) {
        ...
        $KU.log({api:'kony.application.addBMState', enter:true});

        //

        $KU.log({api:'kony.application.addBMState', exit:true});
    };
    ...
    var _addGestureRecognizerForAllForms = function $KAPP_addGestureRecognizerForAllForms(gestureType, gestureConfigParams, onGestureClosure) {
        var $K = kony.$kwebfw$, $KU = $K.utils, id = $KU.uid(), gesture = null;

        $KU.log({api:'kony.application.addGestureRecognizerForAllForms', enter:true});
        ...
        $KU.log({api:'kony.application.addGestureRecognizerForAllForms', exit:true});
    ...
    var _checkPermission = function $KAPP_checkPermission(resourceId, options) {
        var $K = kony.$kwebfw$, $KU = $K.utils, permission = null;

        $KU.log({api:'kony.application.checkPermission', enter:true});
        ...
        case kony.os.RESOURCE_CALENDAR:
            permission = {status:kony.application.PERMISSION_GRANTED, canRequestPermission:false};
        break;
        case kony.os.RESOURCE_CONTACTS:
        case kony.os.RESOURCE_EXTERNAL_STORAGE:
        default:
            permission = {status:kony.application.RESOURCE_NOT_SUPPORTED, canRequestPermission:false};
        break;
        }

        $KU.log({api:'kony.application.checkPermission', exit:true});
    ...
    var _dismissLoadingScreen = function $KAPP_dismissLoadingScreen() {
        ...
        $KU.log({api:'kony.application.dismissLoadingScreen', enter:true});
        ...
        $KU.log({api:'kony.application.dismissLoadingScreen', exit:true});
    };


    //This is defined in konymvc_sdk.js file
    ...
    var _exit = function $KAPP_exit() {
        ...
        $KU.log({api:'kony.application.exit', enter:true});

        window.open('about:blank', '_self', '');

        $KU.log({api:'kony.application.exit', exit:true});
    ...
    var _getApplicationBehavior = function $KAPP_getApplicationBehavior(behavior) {
        ...
        $KU.log({api:'kony.application.getApplicationBehavior', enter:true});

        if($KU.is(behavior, 'string') && behavior) {
            value = $K.behavior[behavior];
        }

        $KU.log({api:'kony.application.getApplicationBehavior', exit:true});
    ...
    var _getApplicationMode = function $KAPP_getApplicationMode() {
        ...
        $KU.log({api:'kony.application.getApplicationMode', enter:true});
        $KU.log({api:'kony.application.getApplicationMode', exit:true});
    ...
    var _getBMState = function $KAPP_getBMState(formId) {
        ...
        $KU.log({api:'kony.application.getBMState', enter:true});

        //

        $KU.log({api:'kony.application.getBMState', exit:true});
    };
    ...
    var _getCurrentBreakpoint = function $KAPP_getCurrentBreakpoint() {
        ...
        $KU.log({api:'kony.application.getCurrentBreakpoint', enter:true});
        $KU.log({api:'kony.application.getCurrentBreakpoint', exit:true});
    ...
    var _getCurrentForm = function $KAPP_getCurrentForm() {
        ...
        $KU.log({api:'kony.application.getCurrentForm', enter:true});
        $KU.log({api:'kony.application.getCurrentForm', exit:true});
    ...
    var _getPreviousForm = function $KAPP_getPreviousForm() {
        ...
        $KU.log({api:'kony.application.getPreviousForm', enter:true});
        $KU.log({api:'kony.application.getPreviousForm', exit:true});
    ...
    var _getWebAssetRelativeURL = function $KAPP_getWebAssetRelativeURL(src, path) {
        var $K = kony.$kwebfw$, $KU = $K.utils, relativePath = src;

        $KU.log({api:'kony.application.getWebAssetRelativeURL', enter:true});
        ...
        $KU.log({api:'kony.application.getWebAssetRelativeURL', exit:true});
    ...
    var _isImageTurnedOff = function $KAPP_isImageTurnedOff(callback) {
        ...
        $KU.log({api:'kony.application.isImageTurnedOff', enter:true});
        ...
        if($KU.is(callback, 'function')) {
            ...
            timeout = setTimeout(function() {
                ...
                $KU.log({api:'kony.application.isImageTurnedOff', exit:true});
            }, 1000);
        }
    };
    ...
    var _isPopupBlocked = function $KAPP_isPopupBlocked(callback) {
        var $K = kony.$kwebfw$, $KU = $K.utils, timeout = null, win = null;

        $KU.log({api:'kony.application.isPopupBlocked', enter:true});
        ...
        if($KU.is(callback, 'function')) {
            timeout = setTimeout(function() {
                ...
                $KU.log({api:'kony.application.isPopupBlocked', exit:true});
            }, 2000);
        }
    };
    ...
    var _openMediaURL = function $KAPP_openMediaURL(url, params, name) {
        ...
        $KU.log({api:'kony.application.openMediaURL', enter:true});

        _openURL(url, params, name);

        $KU.log({api:'kony.application.openMediaURL', exit:true});
    };


    var _openURL = function $KAPP_openURL(url, params, name) {
        var $K = kony.$kwebfw$, $KU = $K.utils, options = null;

        $KU.log({api:'kony.application.openURL', enter:true});
        ...
        $KU.log({api:'kony.application.openURL', exit:true});
    };
    ...
    var _prepareLoadingScreen = function() {
        ...
        $KD.on($KG.appBlocker, 'blur', 'abblur', function(e) {
            var $K = kony.$kwebfw$, $KD = $K.dom, $KA = $K.app;
    ...
    var _registerForIdleTimeout = function $KAPP_registerForIdleTimeout(delay, callback) {
        ...
        $KU.log({api:'kony.application.registerForIdleTimeout', enter:true});
        ...
        $KU.log({api:'kony.application.registerForIdleTimeout', exit:true});
    };
    ...
    var _registerMaster = function $KAPP_registerMaster(config) {
        ...
        $KU.log({api:'kony.application.registerMaster', enter:true});

        _registerUserWidget(config);

        $KU.log({api:'kony.application.registerMaster', exit:true});
    };
    ...
    var _registerUserWidget = function $KAPP_registerUserWidget(config) {
        ...
        $KU.log({api:'kony.application.registerUserWidget', enter:true});
        ...
        userWidgetNamespace[classname] = function(bconfig, lconfig, pspconfig) {
            ...
            if(bconfig.masterType == constants.MASTER_TYPE_USERWIDGET) {
                ...
                model = kony.$kwebfw$.ComponentWithContract(bconfig, lconfig, pspconfig, name);
            } else {
                model = kony.$kwebfw$.ComponentWithoutContract(bconfig, lconfig, pspconfig, name);
            }

            return model;
        };

        $KU.log({api:'kony.application.registerUserWidget', exit:true});
    ...
    var _removeBMState = function $KAPP_removeBMState(formId, keey) {
        ...
        $KU.log({api:'kony.application.removeBMState', enter:true});

        //

        $KU.log({api:'kony.application.removeBMState', exit:true});
    };
    ...
    var _removeGestureRecognizerForAllForms = function $KAPP_removeGestureRecognizerForAllForms(uid) {
        var $K = kony.$kwebfw$, $KU = $K.utils, list = null, position = -1;

        $KU.log({api:'kony.application.removeGestureRecognizerForAllForms', enter:true});
        ...
        $KU.log({api:'kony.application.removeGestureRecognizerForAllForms', exit:true});
    };
    ...
    var _removeSeoDataReadyFlag = function $KAPP_removeSeoDataReadyFlag() {
        ...
        $KU.log({api:'kony.application.removeSeoDataReadyFlag', enter:true});
        $KD.removeAttr(body, 'data-ready');
        $KU.log({api:'kony.application.removeSeoDataReadyFlag', exit:true});
    };
    ...
    var _requestPermission = function $KAPP_requestPermission(resourceId, callback, options) {
        ...
        $KU.log({api:'kony.application.requestPermission', enter:true});
        ...
        $KU.log({api:'kony.application.requestPermission', exit:true});
    };
    ...
    var _resetBMState = function $KAPP_resetBMState() {
        ...
        $KU.log({api:'kony.application.resetBMState', enter:true});

        //

        $KU.log({api:'kony.application.resetBMState', exit:true});
    };


    var _resetBodyHTML = function() {
        var html = '', body = document.body;

        html += '<div id="skip" hidden style="z-index:2147483647 !important;"></div>';
        html += '<div kr="app_forms"></div>';
        html += '<div kr="app_dialogs" style="z-index:2147483647 !important;"></div>';
        html += '<div kr="app_scrap"></div>';
        html += '<div kr="app_blocker" style="z-index:2147483647 !important;" hidden aria-hidden="true"></div>';
    ...
    var _setApplicationBehaviors = function $KAPP_setApplicationBehaviors(behaviors) {
        ...
        $KU.log({api:'kony.application.setApplicationBehaviors', enter:true});
        ...
        $KU.log({api:'kony.application.setApplicationBehaviors', exit:true});
    };
    ...
    var _setApplicationInitializationEvents = function $KAPP_setApplicationInitializationEvents(evt) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
            $KG = $K.globals, $KD = $K.dom, body = $KD.body(),
            launch = {params:{}}, form = null, home = null,
            $KAR = $K.automation.recorder, testresources = null,
            testAutomationScriptURL = null, konyAutomationPath = null,
            params = window.location.search, protocol = null;

        $KU.log({api:'kony.application.setApplicationInitializationEvents', enter:true});
        ...
        launch.params.isNewSPASession = (kony.appinit.isNewSession === 'true');
        ...
        if(appConfig.testAutomation) {
            window._kony.automation = {}; // for IntegrationTests object to be available globally
            ...
            && testAutomationScriptURL.startsWith('http')) {
                konyAutomationPath = testAutomationScriptURL + "Desktop";
                setTimeout(function() {
        ...
        $KU.log({api:'kony.application.setApplicationInitializationEvents', exit:true});
    };
    ...
    var _setApplicationMode = function $KAPP_setApplicationMode(mode) {
        ...
        $KU.log({api:'kony.application.setApplicationMode', enter:true});
        $KA.mode = (supportedModes.indexOf() === -1) ? constants.APPLICATION_MODE_NATIVE : mode;
        $KU.log({api:'kony.application.setApplicationMode', exit:true});
    };
    ...
    var _setBMState = function $KAPP_setBMState(formId, state) {
        ...
        $KU.log({api:'kony.application.setBMState', enter:true});

        //

        $KU.log({api:'kony.application.setBMState', exit:true});
    };
    ...
    var _showForm = function(evt, home, launch) {
        ...
        if(home) {
            if($KU.is(home, 'string')) {
                ...
                if(!form || form._konyControllerName) {
                    _kony.mvc.navigate(home);
                } else {
                    form.show();
                }
            } else {
    ...
    var _setGestureRecognizerForAllForms = function $KAPP_setGestureRecognizerForAllForms() {
        ...
        $KU.log({api:'kony.application.setGestureRecognizerForAllForms', enter:true});

        //

        $KU.log({api:'kony.application.setGestureRecognizerForAllForms', exit:true});
    };
    ...
    var _setSeoDataReadyFlag = function $KAPP_setSeoDataReadyFlag() {
        ...
        $KU.log({api:'kony.application.setSeoDataReadyFlag', enter:true});
        $KD.setAttr(body, 'data-ready', 1);
        $KU.log({api:'kony.application.setSeoDataReadyFlag', exit:true});
    };
    ...
    var _setupWidgetDataRecording = function $KAPP_setupWidgetDataRecording() {
        ...
        $KU.log({api:'kony.application.setupWidgetDataRecording', enter:true});
        $KA.behavior.recording = true;
        $KU.log({api:'kony.application.setupWidgetDataRecording', exit:true});
    };
    ...
    var _showLoadingScreen = function $KAPP_showLoadingScreen(skin, text, position, isBlocked, showProgressIndicator, properties) {
        ...
        $KU.log({api:'kony.application.showLoadingScreen', enter:true});
        ...
        if(!$KU.is($KA.blocked, 'boolean')) {
            ...
            $KG.appBlocker.className = ((skin) ? skin : '-kony-loading');
        ...
        $KU.log({api:'kony.application.showLoadingScreen', exit:true});
    };
    ...
    var _unregisterForIdleTimeout = function $KAPP_unregisterForIdleTimeout() {
        ...
        $KU.log({api:'kony.application.unregisterForIdleTimeout', enter:true});
        ...
        $KU.log({api:'kony.application.unregisterForIdleTimeout', exit:true});
    };
    ...
    $K.defKonyProp(_ns, [
        ...
        //{keey:'destroyForm', value:_destroyForm}, //This is defined in konymvc_sdk.js file
...
/* FILE PATH :: 'lib/apis/konyconstants.js' */
/* global kony */
Object.defineProperty(window, 'constants', {configurable:false, enumerable:false, writable:true, value:(function() {
    ...
    $K.defKonyProp(_ns, [
        ...
        {keey:'TEXTBOX_KEY_BOARD_STYLE_CHAT', value:'chatpad'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_DECIMAL', value:'number'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_DEFAULT', value:'default'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_EMAIL', value:'emailpad'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_NUMBER_PAD', value:'digitpad'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_PHONE_PAD', value:'telpad'},
        {keey:'TEXTBOX_KEY_BOARD_STYLE_URL', value:'urlpad'},
        ...
        {keey:'TEXTAREA_KEY_BOARD_STYLE_CHAT', value:'chatpad'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_DECIMAL', value:'number'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_DEFAULT', value:'default'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_EMAIL', value:'emailpad'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_NUMBER_PAD', value:'number'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_PHONE_PAD', value:'telpad'},
        {keey:'TEXTAREA_KEY_BOARD_STYLE_URL', value:'urlpad'},
...
Object.defineProperty(kony, 'anim', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'calendar', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'canvas', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'collectionview', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'flex', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'map', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'segment', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
Object.defineProperty(kony, 'skin', {configurable:false, enumerable:false, writable:true, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
...
/* FILE PATH :: 'lib/apis/konycrypto.js' */
/* global kony */
/* global CryptoJS */
...
/* FILE PATH :: 'lib/apis/konydb.js' */
/* global kony */
/* globals constants */
Object.defineProperty(kony, 'db', {configurable:false, enumerable:false, writable:false, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
    ...
    var _changeVersion = function(db, oldver, newver, transcb, ecb, vcb) {
        ...
        $KU.log({api:'kony.db.changeVersion', enter:true});

        if(window.openDatabase) {
            db && db.changeVersion(oldver, newver, transcb, ecb, vcb);
            $KU.log({api:'kony.db.changeVersion', exit:true});
        } else {
    ...
    var _executeSql = function(transid, sqlstmt, args, scb, ecb) {
        ...
        $KU.log({api:'kony.db.executeSql', enter:true});
        ...
        if(window.openDatabase) {
            ...
            $KU.log({api:'kony.db.executeSql', exit:true});
        } else {
            kony.print('Web Databases not supported.');
        }
    };
    ...
    var _openDatabase = function(name, version, dname, size, cb) {
        var $K = kony.$kwebfw$, $KU = $K.utils, db = this.db || null;

        $KU.log({api:'kony.db.openDatabase', enter:true});
        ...
        try {
            if(window.openDatabase) {
                ...
                $KU.log({api:'kony.db.openDatabase', exit:true});
            } else {
                kony.print('Web Databases not supported.');
            }
        } catch(e) {
    ...
    var _readTransaction = function(db, transcb, ecb, vcb) {
        ...
        $KU.log({api:'kony.db.readTransaction', enter:true});

        if(window.openDatabase) {
            db && db.readTransaction(transcb, ecb, vcb);
            $KU.log({api:'kony.db.readTransaction', exit:true});
        } else {
            kony.print('Web Databases not supported.');
        }
    };
    ...
    var _sqlResultsetRowItem = function(transid, sqlresultset, index) {
        var $K = kony.$kwebfw$, $KU = $K.utils, item = null;

        $KU.log({api:'kony.db.sqlResultsetRowItem', enter:true});
        ...
        $KU.log({api:'kony.db.sqlResultsetRowItem', exit:true});
        return item;
    };
    ...
    var _transaction = function(db, transcb, ecb, vcb) {
        ...
        $KU.log({api:'kony.db.transaction', enter:true});

        if(window.openDatabase) {
            db && db.transaction(transcb, ecb, vcb);
            $KU.log({api:'kony.db.transaction', exit:true});
        } else {
            kony.print('Web Databases not supported.');
        }
    };
...
(function() {
    ...
    var _valueAt = function(index, namespace, arg2) {
        var $K = kony.$kwebfw$, $KU = $K.utils,
            store = $KU.getLocalStorage(), data = null;
...
/* FILE PATH :: 'lib/apis/konyi18n.js' */
/* global kony */
/* global constants */
/* global navigator */
Object.defineProperty(kony, 'i18n', {configurable:false, enumerable:false, writable:false, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$;
    ...
    var _cleanupI18nCache = function $KI18N_cleanupI18nCache() {
        ...
        $KU.log({api:'kony.i18n.cleanupI18nCache', enter:true});

        $KU.each($KA.supportedLocales, function(locale) {
            var $K = kony.$kwebfw$, $KA = $K.app, $KS = $K.store,
        ...
        $KU.log({api:'kony.i18n.cleanupI18nCache', exit:true});
    };


    var _deleteResourceBundle = function $KI18N_deleteResourceBundle(locale) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KA = $K.app, $KL = $K.locale,
            $KS = $K.store, key = ($KA.id+'_'+locale), index  = -1;

        $KU.log({api:'kony.i18n.deleteResourceBundle', enter:true});
        ...
        $KU.log({api:'kony.i18n.deleteResourceBundle', exit:true});
    };


    var _determineCurrentLocale = function $KI18N_determineCurrentLocale() {
        var $K = kony.$kwebfw$, $KA = $K.app, locales = $KA.supportedLocales,
    ...
    var _getBrowserLanguage = function $KI18N_getBrowserLanguage() {
        var $K = kony.$kwebfw$, $KG = $K.globals, $KA = $K.app,
    ...
    var _getCurrentDeviceLocale = function $KI18N_getCurrentDeviceLocale() {
        ...
        $KU.log({api:'kony.i18n.getCurrentDeviceLocale', enter:true});
        $KU.log({api:'kony.i18n.getCurrentDeviceLocale', exit:true});
    ...
    var _getCurrentLocale = function $KI18N_getCurrentLocale() {
        ...
        $KU.log({api:'kony.i18n.getCurrentLocale', enter:true});
        $KU.log({api:'kony.i18n.getCurrentLocale', exit:true});
    ...
    var _getLocalizedString = function $KI18N_getLocalizedString(i18nKey) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KL = $K.locale,
            $KA = $K.app, i18nValue = $KL[$KA.currentLocale];

        $KU.log({api:'kony.i18n.getLocalizedString', enter:true});

        if(i18nValue) i18nValue = i18nValue[i18nKey];

        $KU.log({api:'kony.i18n.getLocalizedString', exit:true});
    ...
    var _getSupportedLocales = function $KI18N_getSupportedLocales() {
        var $K = kony.$kwebfw$, $KU =$K.utils, lang = '';

        $KU.log({api:'kony.i18n.getSupportedLocales', enter:true});
        $KU.log('warn', 'getsupportedlocales: Not supported!');
        lang = _getBrowserLanguage();
        $KU.log({api:'kony.i18n.getSupportedLocales', exit:true});
    ...
    var _initializeI18n = function $KI18N_initializeI18n(locale, initializeFn, successcallback, errorcallback, info) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom, $KA = $K.app,
    ...
    var _setCurrentLocaleAsync = function $KI18N_setCurrentLocaleAsync(localename, onsuccesscallback, onfailurecallback, info) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KA = $K.app, locales = $KA.supportedLocales;

        $KU.log({api:'kony.i18n.setCurrentLocaleAsync', enter:true});
        ...
        $KU.log({api:'kony.i18n.setCurrentLocaleAsync', exit:true});
    };
    ...
    var _setDefaultLocale = function $KI18N_setDefaultLocale(localename, onsuccesscallback, onerrorcallback, initializeFn) {
        ...
        $KU.log({api:'kony.i18n.setDefaultLocale', enter:true});
    ...
    var _setDefaultLocaleAsync = function $KI18N_setDefaultLocaleAsync(localename, onsuccesscallback, onfailurecallback, info) {
        ...
        $KU.log({api:'kony.i18n.setDefaultLocaleAsync', exit:true});
    };
    ...
    var _setLocaleLayoutConfig = function $KI18N_setLocaleLayoutConfig(config) {
        ...
        $KU.log({api:'kony.i18n.setLocaleLayoutConfig', enter:true});

        if($KU.is(config, 'object')) {
            $KA.localeLayoutConfig = config;
        }

        $KU.log({api:'kony.i18n.setLocaleLayoutConfig', exit:true});
    };
    ...
    var _setResourceBundle = function $KI18N_setResourceBundle(inputtable, locale) {
        ...
        $KU.log({api:'kony.i18n.setResourceBundle', enter:true});
        ...
        $KU.log({api:'kony.i18n.setResourceBundle', exit:true});
    };


    var _updateResourceBundle = function $KI18N_updateResourceBundle(inputtable, locale) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KA = $K.app, bundle = null,
            $KL = $K.locale, $KS = $K.store, key = ($KA.id+'_'+locale);

        $KU.log({api:'kony.i18n.updateResourceBundle', enter:true});
        ...
        $KU.log({api:'kony.i18n.updateResourceBundle', exit:true});
    };
...
/* FILE PATH :: 'lib/apis/konyio.js' */
/* global kony */
Object.defineProperty(kony, 'io', {configurable:false, enumerable:false, writable:false, value:(function() {
    var _ns = {}, $K = kony.$kwebfw$, _iframe = null,
        _form = null, _input = null, _scrap = null;


    var _ajaxBrowse = function(e, callback) {
        var $K = kony.$kwebfw$, $KU = $K.utils, files = [];
    ...
    var _ajaxUpload = function(url, state, index, callback, config) {
        ...
        formData.append(state.file.name, state.file);
        ...
        xhr.onload = function(e) {
            if(this.status == 200) {
                ...
                state.uploadBytes = state[index].file.size;
                callback && callback(url, state);
            }
        };
    ...
    var File = function(file) {
        ...
        $KU.log({api:'kony.io.File', enter:true});
        ...
        $KU.log({api:'kony.io.File', exit:true});
    };
    ...
    var FileSystem_browse = function(config, callback) {
        ...
        $KU.log({api:'kony.io.FileSystem.browse', enter:true});
        ...
        $KU.log({api:'kony.io.FileSystem.browse', exit:true});
    };
    ...
    var FileSystem_uploadFiles = function(url, files, callBack, config) {
        ...
        $KU.log({api:'kony.io.FileSystem.uploadFiles', enter:true});
        ...
        $KU.log({api:'kony.io.FileSystem.uploadFiles', exit:true});
    };
...
/* FILE PATH :: 'lib/apis/konylocation.js' */
/* global kony */
...
/* FILE PATH :: 'lib/apis/konymodules.js' */
/* global kony */
    ...
    var _integrity = {
        ...
        validateHostNamesList: function Integrity$validateHostNamesList(hostNamesList) {
            var $K = kony.$kwebfw$, $KU = $K.utils, i = 0, j = 0, domain = null,
                domainArr = null, domainLen = 0, regex = /^[A-Za-z0-9\\\-]+$/;
...
Object.defineProperty(kony, 'os', {configurable:false, enumerable:false, writable:false, value:(function() {
    ...
    var _buildPrintWindow = function(win, widget, width) {
        ...
        for(stylesheet = 0; stylesheet < docstylesheets.length; stylesheet++) {
            ...
            && docstylesheets[stylesheet].href.indexOf('desktopweb/konydesktop.css') === -1) {
    ...
    var _freeMemory = function() {
        ...
        $KU.log({api:'kony.os.freeMemory', enter:true});
        $KU.log({api:'kony.os.freeMemory', exit:true});
    ...
    var _getBatteryState = function() {
        ...
        $KU.log({api:'kony.os.getBatteryState', enter:true});
        $KU.log({api:'kony.os.getBatteryState', exit:true});

        return kony.os.BATTERY_STATE_UNKNOWN;
    };


    var _getDeviceCurrentOrientation = function() {
        var $K = kony.$kwebfw$, $KU = $K.utils, orientation = '';

        $KU.log({api:'kony.os.getDeviceCurrentOrientation', enter:true});

        orientation = $KU.browser('orientation');

        $KU.log({api:'kony.os.getDeviceCurrentOrientation', exit:true});
    ...
    var _handlePrint = {
        Form2: function(win, info) {
            ...
            cssText += ' position: relative !important;';
            cssText += ' bottom: auto !important;';
            if(this.layoutType === kony.flex.FREE_FORM) {
    ...
    var _hasCameraSupport = function() {
        ...
        $KU.log({api:'kony.os.hasCameraSupport', enter:true});
        flag = $KU.browser('supports', 'usermedia');
        $KU.log({api:'kony.os.hasCameraSupport', exit:true});
    ...
    var _hasGPSSupport = function() {
        var $K = kony.$kwebfw$, $KU = $K.utils, gps = false;

        $KU.log({api:'kony.os.hasGPSSupport', enter:true});
        gps = $KU.browser('supports', 'geolocation');
        $KU.log({api:'kony.os.hasGPSSupport', exit:true});
    ...
    var _hasOrientationSupport = function() {
        var $K = kony.$kwebfw$, $KU = $K.utils, hasOrientation = false;

        $KU.log({api:'kony.os.hasOrientationSupport', enter:true});
        hasOrientation = $KU.browser('supports', 'orientation');
        $KU.log({api:'kony.os.hasOrientationSupport', exit:true});
    ...
    var _hasTouchSupport = function() {
        ...
        $KU.log({api:'kony.os.hasTouchSupport', enter:true});
        flag = $KU.browser('supports', 'touch');
        $KU.log({api:'kony.os.hasTouchSupport', exit:true});
    ...
    var _print = function(widgetId) {
        ...
        $KU.log({api:'kony.os.print', enter:true});
        ...
        if(!win) {
            ...
            if(_handlePrint.Form2) {
                $KU.each($KW.children(cf), function(cmodel) {
                    ...
                    if(cf.layoutType === kony.flex.FLOW_VERTICAL) {
                ...
                if(cf.layoutType === kony.flex.FREE_FORM) {
        ...
        $KU.log({api:'kony.os.print', exit:true});
    };
...
/* FILE PATH :: 'lib/apis/konyphone.js' */
/* global kony */
/* global FileError */
...
/* FILE PATH :: 'lib/apis/konytheme.js' */
/* global kony */
...
/* FILE PATH :: 'lib/apis/konytimer.js' */
/* global kony */
...
/* FILE PATH :: 'lib/apis/konyworker.js' */
/* global kony */
