$KW.FlexScrollContainer = (function() {
    ...
    var module = {
        ...
        getScrollStyle: function(boxModel) {
            var scrolldirection = kony.widgets.stringifyScrolldirection[boxModel.scrolldirection], style = '';
        ...
        render: function(boxModel, context) {
            ...
            if(boxModel.layoutType == kony.flex.RESPONSIVE_GRID) {
                style += $KW.FlexUtils.getResponsiveContainerLayoutStyle(boxModel);
            } else {
                style += 'position: relative;'
            }

            var htmlString = "<div style='" + style + boxStyle + "' class ='" + computedSkin + "'" + kony.widgets.Utils.getBaseHtml(boxModel, context) + " swipeDirection='" + scrolldirection + "'>";
