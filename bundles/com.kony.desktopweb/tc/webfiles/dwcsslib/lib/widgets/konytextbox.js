...
(function() {
        ...
        TextBox2: function TextBox2$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.TextBox2', null);
                }
            }
            if(!_.name) {
    ...
    var _setInputType = function TextBox2$_setInputType(input) {
        ...
        || this.keyBoardStyle === constants.TEXTBOX_KEY_BOARD_STYLE_NUMBER_PAD) {
    ...
    Object.defineProperty(kony.ui, 'TextBox2', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.TextBox2 constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.TextBox2>, but not in <_valid.TextBox2> namespace.');
                        } else {
        ...
        $K.utils.inherits(TextBox2, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.TextBox2 widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.TextBox2
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – TextBox2 view.
         */
        var textbox2__render = function TextBox2$_render(tag) {
            var $super = kony.ui.TextBox2.base.prototype,
        ...
        var textbox2_setFocus = function TextBox2$setFocus(value) {
            var $super = kony.ui.TextBox2.base.prototype, $K = kony.$kwebfw$,
        ...
        $K.defKonyProp(TextBox2.prototype, [
