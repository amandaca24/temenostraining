...
kony.defaults.Canvas = function(config1, config2, config3) {
    kony.Canvas = kony.defaults.merge(config1, config2, config3);
    kony.defaults.widget.Canvas = kony.Canvas;
}

kony.defaults.Canvas0d2862f0e24a549 = new kony.defaults.Canvas({
    "id": "Canvas",
    "isVisible": true
}, {
    "containerWeight": 100,
