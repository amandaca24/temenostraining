...
(function() {
        ...
        CheckBoxGroup: function CheckBoxGroup$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.CheckBoxGroup', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'CheckBoxGroup', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.CheckBoxGroup constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.CheckBoxGroup>, but not in <_valid.CheckBoxGroup> namespace.');
                        } else {
        ...
        $K.utils.inherits(CheckBoxGroup, kony.ui.GroupWidget);


        /**
         * Builds the view layer for kony.ui.CheckBoxGroup widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.CheckBoxGroup
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – SampleWidget view.
         */
        var checkboxgroup__render = function CheckBoxGroup$_render(tag) {
            var $super = kony.ui.CheckBoxGroup.base.prototype,
        ...
        $K.defKonyProp(CheckBoxGroup.prototype, [
