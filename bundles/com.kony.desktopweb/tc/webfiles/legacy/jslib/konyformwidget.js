    ...
    var module = {
        ...
        resizeHandler: function(formModel, width) {
            ...
            if(module.breakpointChanged(formModel, width)) {
                kony.events.executeActionOnComponent([formModel], {
            ...
            if(window.scrollY && kony.appinit.isiPhone && kony.appinit.isSafari) {
                window.scrollTo(0, 0);
            }
        },
        ...
        generateForm: function(formModel) {
            ...
            if(formModel.layouttype == kony.flex.RESPONSIVE_GRID) {
            ...
            return function() {
                ...
                if(formModel) {
                    ...
                    if(curForm && curForm.id != formModel.id) {
                        kony.events.executeActionOnContainer(curForm, {
                            "eventType" : "onhide",
                            "execActionBeforeChildFlag" : false
                        });
                    ...
                    kony.events.executeActionOnContainer(formModel, {
                        "eventType" : "preshow",
                        "execActionBeforeChildFlag" : true
                        });
                    ...
                    if(!rendered) {
                        ...
                        if(prevForm && (kony.appinit.isMob || kony.appinit.isTablet)) { 
                        ...
                        if((kony.appinit.isMob || kony.appinit.isTablet) && prevForm && $KW.FlexUtils.isFlexContainer(formModel) && $KW.FlexUtils.isFlexContainer(prevForm)) {
        ...
        endTransition: function(src, dest, currentForm, previousForm) {
            ...
            kony.events.executeActionOnContainer(currentForm, {
                                        "eventType" : "postshow",
                                        "execActionBeforeChildFlag" : false
                                        });
            if($KC.widgetDataRecording == true) {
