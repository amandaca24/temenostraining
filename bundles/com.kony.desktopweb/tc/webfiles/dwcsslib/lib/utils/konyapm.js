/* global kony */
Object.defineProperty(kony.$kwebfw$, 'apm', {configurable:false, enumerable:false, writable:false, value:(function() {
    var $K = kony.$kwebfw$, _foreGroundAt = null, _formEntryAt = null,
    ...
    var _send = function $KAPM_send(widget, event, params) {
        var $K = kony.$kwebfw$, $KW = $K.widget, $KA = $K.app, wid = '',
    ...
    var _startTracking = function $KAPM_startTracking(events) {
        var $K = kony.$kwebfw$, $KU = $K.utils, sdk = null;
        ...
        if(_trackEvents) {
            try {
                sdk = kony.sdk.getDefaultInstance();
