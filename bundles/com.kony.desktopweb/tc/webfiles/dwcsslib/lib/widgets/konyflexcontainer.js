...
(function() {
        ...
        FlexContainer: function FlexContainer$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.FlexContainer', true);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'FlexContainer', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.FlexContainer constructor.
         *
         * @class
         * @namespace   kony.ui
            ...
            if(dependentPropertiesValidationMessage) {
                ...
                $KU.each(prop, function(value, key) {
                    ...
                    if(!bconfig.hasOwnProperty(key)) {
                        ...
                        throw new Error('<'+key+'> is available in default widget properties of <kony.ui.FlexContainer>, but not in <_valid.FlexContainer> namespace.');
                    } else {
        ...
        $K.utils.inherits(FlexContainer, kony.ui.ContainerWidget);


        /**
         * Builds the view layer for kony.ui.FlexContainer widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.FlexContainer
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – FlexContainer view.
         */
        var flexcontainer__render = function FlexContainer$_render(tag, children) {
            var $super = kony.ui.FlexContainer.base.prototype, _ = this._kwebfw_,
                $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
                $KD = $K.dom, view = _.view, el = $KW.el(view);
        ...
        $K.defKonyProp(FlexContainer.prototype, [
