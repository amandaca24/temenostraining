...
(function() {
            ...
            CollectionView: {
                ...
                _remove: function CollectionView$_action_remove(secIndex, itemIndex, count) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom,
                        ...
                        removeSelectedIndex = -1, itemNode = null, itemToDelete = null;
                        ...
                        if(el.node) {
                            ...
                            if(clone) {
                                ...
                                if(_animator.CollectionView.canAnimate.call(this, anim)) {
                                    _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.ADD, [clone]);
                    ...
                    _iterateOverData.call(this, widgetdata, function(widgetdata, counter) {
                        ...
                        if(el.node) {
                            ...
                            if(clone) {
                                ...
                                if(_animator.CollectionView.canAnimate.call(this, anim)) {
                                    _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.UPDATE, [clone]);
                ...
                remove: function CollectionView$_action_remove(secIndex, itemIndex, count, anim) {
                    ...
                    if(_animator.CollectionView.canAnimate.call(this, anim)) {
                        ...
                        _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.REMOVE, [_.items[absIndex]]);
                    ...
                    if(el.node) {
                        ...
                        if(clones.length > 0) {
                            ...
                            if(_animator.CollectionView.canAnimate.call(this, anim)) {
                                ...
                                _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.ADD, clones);
                ...
                addsectionat: function CollectionView$_action_addsectionat(secIndex, itemIndex, newdata, updateIndicesFlag, anim) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, $KU = $K.utils,
                        ...
                        absIndex = 0, prevLength, items = [], item = null, counter = 0;;
                        ...
                        $KU.each(newdata, function(newdata, counter) {
                            ...
                            if(absIndex === _.items.length) {
                                if(clones.length > 0) {
                                    ...
                                    if(_animator.CollectionView.canAnimate.call(this, anim)) {
                                        items = [].slice.call($KD.children(el.scrolee), prevLength);
                                        _animator.CollectionView.onItemDisplayHandler.call(this, updateIndicesFlag ? kony.segment.ADD: kony.segment.UPDATE, clones);
                ...
                removesectionat: function CollectionView$_action_removesectionat(secIndex, itemIndex, updateIndicesFlag, count, anim) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom,
                            ...
                            el = $KW.el(this), absIndex = null,item, items = [], cloneModels = [];
                    ...
                    if(_animator.CollectionView.canAnimate.call(this, anim)) {
                        absIndex = _absoluteItemIndex.call(this, secIndex, itemIndex);
                            ...
                            _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.REMOVE, cloneModels);
           ...
           CollectionView: {
                applyItemsAnimationByAPI: function CollectionView$_animator_applyItemsAnimationByAPI(action, listItems, itemIndex, secIndex, animObj) {
                    var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, $KD = $K.dom,
                        animDef = null, el = $KW.el(this), segmodel = this, item = null,
                        items = [],
                ...
                handleOnItemDisplay: function() {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KU = $K.utils, $KD = $K.dom,
                        visibleItems, visibleIndeces, allItems =  this._kwebfw_.items, itemContext;
                ...
                onItemDisplayHandler: function CollectionView$_animator_onItemDisplayHandler(action, items) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, $KU = $K.utils, _ = this._kwebfw_,
                        visibleLastItem = null, visibleLastItem = null,
        ...
        var _applyLineSpaceAndItemSpace = function CollectionView$__applyLineSpaceAndItemSpace() {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom, $KW = $K.widget;
            var _applyMarginForLastItem = function(model, width, height) {//TODO
                    var parentValue = 0;
                    var parentNode = $KW.el(model).node;
                    if(model.layout == kony.collectionview.LAYOUT_HORIZONTAL) {
                        ...
                        $KD.style(prevWidget.flexNode, 'margin-right', cvWidth - width + 'px');
                    } else if(model.layout == kony.collectionview.LAYOUT_VERTICAL) {
                        ...
                        $KD.style(prevWidget.flexNode, 'margin-bottom', cvHeight - height + 'px');
                    }
                },
                ...
                _getNodeAndModel = function(itemNode) {//TODO
                    var flexModel = null, itemNode, index;

                    if(itemNode) {
                        index = itemNode.getAttribute('kii').split(',');
                        var flexModel = _getClonedTemplate.call(this, parseInt(index[0]), parseInt(index[1]));
            ...
            if(data && data.length > 0) {
                ...
                for(i = 0; i < itemNodes.length; i++) {
                    ...
                    if(itemNode) {
                        ...
                        if(this.layout == kony.collectionview.LAYOUT_HORIZONTAL) {
                        ...
                        } else if(this.layout == kony.collectionview.LAYOUT_VERTICAL) {
        ...
        var _getFrameworkHeaderTemplate = function CollectionView$_getFrameworkHeaderTemplate() {
            var flx = null, lbl = null,
                bconfig = {
                    ...
                    'autogitemMode': kony.flex.AUTOGROW_HEIGHT
                };
        ...
        var _getIndexedInfo = function CollectionView$_getIndexedInfo(index, data) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, item = null,
                _ = this._kwebfw_, prop  =_.prop, secIndex = -1, itemIndex = -1;
        ...
        var _getVisibleItems = function CollectionView$_getVisibleItems(config) {
            var $K = kony.$kwebfw$, $KW = $K.widget, $KU = $K.utils,
                ...
                index = null, visibleIndex = null, prop = this._kwebfw_.prop;
        ...
        var _handleScrollDirection = function CollectionView$_handleScrollDirection(el) {
            var $K = kony.$kwebfw$, $KD = $K.dom;
            if(this.layout === kony.collectionview.LAYOUT_CUSTOM) {
                switch(this.scrollDirection) {
                    case kony.collectionview.SCROLL_DIRECTION_BOTH:
                        $KD.style(el, 'overflow', 'auto');
                    break;
                    case kony.collectionview.SCROLL_DIRECTION_VERTICAL:
                        $KD.style(el, {overflowY: 'auto', overflowX: 'hidden'});
                    break;
                    case kony.collectionview.SCROLL_DIRECTION_HORIZONTAL:
        ...
        var _onItemChange = function CollectionView$_onItemChange(secIndex, itemIndex, action, data, count, anim) {
            ...
            var $K = kony.$kwebfw$, $KD = $K.dom, $KW = $K.widget, el = $KW.el(this);
            ...
            CollectionView: function CollectionView$_populateUnderscore() {
                ...
                if(!_.ns) {
                    if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                        ...
                        $KU.defineProperty(_, 'ns', 'kony.ui.CollectionView', null);
                    }
                }
                if(!_.name) {
        ...
        var _renderItems = function CollectionView$_renderItems(clones) {
            var $K = kony.$kwebfw$, $KD = $K.dom, $KU = $K.utils,
                ...
                createItem = function(clone) {
                    var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom,
                        itemNode = $KD.create('DIV'), item = null,
        ...
        var _setHorizontalLayout = function CollectionView$_setHorizontalLayout(el) {
            ...
            $KD.setAttr(el.scrolee, 'kv', kony.collectionview.LAYOUT_HORIZONTAL);
        ...
        var _setVerticalLayout = function CollectionView$_setVerticalLayout(el) {
            var $K = kony.$kwebfw$, $KD = $K.dom, $KU = $K.utils,
                rows = this._kwebfw_.rows;
            $KD.setAttr(el.scrolee, 'kv', kony.collectionview.LAYOUT_VERTICAL);
            $KD.style(el.scrolee, {'transition': null, 'transform': null, 'width': null});
        };
        ...
        var _setCustomLayout = function CollectionView$_setCustomLayout(el) {
            var $K = kony.$kwebfw$, $KD = $K.dom, $KU = $K.utils,
                rows = this._kwebfw_.rows;
            $KD.setAttr(el.scrolee, 'kv', kony.collectionview.LAYOUT_CUSTOM);
            $KD.style(el.scrolee, {'transition': null, 'transform': null, 'width': null});
        };
            ...
            CollectionView: {
                ...
                selectedItemIndex: function CollectionView$_setter_selectedItemIndex(old) {
                    ...
                    if(!prop.selectedItemIndex) {
                        ...
                        if(prop.selectionBehavior === kony.collectionview.SINGLE_SELECT) {
                            deSelectedItem = _.selectedItems.splice(0, _.selectedItems.length, prop.selectedItemIndex.slice(0));
                        } else if(prop.selectionBehavior === kony.collectionview.MULTI_SELECT) {
        ...
        var _updateSectionFooterSkin = function CollectionView$_updateSectionFooterSkin() {
            var $K = kony.$kwebfw$, $KU = $K.utils, headerItems = [];
    ...
    var _valid = {
        CollectionView: {
            ...
            contentOffsetMeasured: function CollectionView$_valid_contentOffsetMeasured() {
                var $K = kony.$kwebfw$, $KU = $K.utils, flag = false;
            ...
            layout: function CollectionView$_valid_layout(value) {
                var flag = false, options = [
                    kony.collectionview.LAYOUT_VERTICAL,
                    kony.collectionview.LAYOUT_HORIZONTAL,
                    kony.collectionview.LAYOUT_CUSTOM
                ];
            ...
            scrollDirection: function CollectionView$_valid_scrollDirection(value) {
                var $K = kony.$kwebfw$, $KU = $K.utils, flag = false, options = [
                    kony.collectionview.SCROLL_DIRECTION_BOTH,
                    kony.collectionview.SCROLL_DIRECTION_HORIZONTAL,
                    kony.collectionview.SCROLL_DIRECTION_VERTICAL
                ];
            ...
            selectedItemIndex: function CollectionView$_valid_selectedItemIndex(value) {
                ...
                && prop.hasOwnProperty('selectedItemIndex')) {
            ...
            selectedItemIndices: function CollectionView$_valid_selectedItemIndices(value) {
                var $K = kony.$kwebfw$, $KU = $K.utils, count = 0, flag = true,
                    ...
                    prop = _.prop, secIndex = -1, itemIndexes = [];
            ...
            selectionBehavior: function CollectionView$_valid_selectionBehavior(value) {
                var flag = false, options = [
                    kony.collectionview.SINGLE_SELECT,
                    kony.collectionview.MULTI_SELECT
                ];
        ...
        CollectionView: {
            ...
            data: function CollectionView$_view_data(el, old) {
                var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom,
                    ...
                    height = 0, secIndex = -1, itemIndex = -1;
            ...
            layout: function CollectionView$_view_layout(el, old) {
                ...
                if(this._kwebfw_.prop.layout === kony.collectionview.LAYOUT_HORIZONTAL) {
                    _setHorizontalLayout.call(this, el);
                } else if(this._kwebfw_.prop.layout === kony.collectionview.LAYOUT_VERTICAL) {
            ...
            selectedItemIndex: function CollectionView$_view_selectedItemIndex(el, old) {
                var $K = kony.$kwebfw$, $KW = $K.widget, _ = this._kwebfw_,
                    prop = _.prop, itemIndex = 0, selectedItem = null;

                if($KW.visible(this) && prop.selectedItemIndex) {
                    itemIndex = prop.selectedItemIndex[1];

                    //_.setFocus is set in konyevent.js _setOwnerSelectedIndex.CollectionView function
    ...
    Object.defineProperty(kony.ui, 'CollectionView', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.CollectionView constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.CollectionView>, but not in <_valid.CollectionView> namespace.');
                        } else {
        ...
        $K.utils.inherits(CollectionView, kony.ui.BasicWidget);
         ...
         * @access      protected
         * @method      _flush
         * @memberof    kony.ui.CollectionView
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     void
         */
        var collectionview_flush = function CollectionView$_flush(config) {
            var $super = kony.ui.CollectionView.base.prototype;
        ...
        var collectionview_render = function CollectionView$_render(tag, context) {
            var $super = kony.ui.CollectionView.base.prototype, _ = this._kwebfw_,
        ...
        var collectionview_appendLayoutDataAt =  function CollectionView$appendLayoutDataAt( data, itemIndex, sectionIndex) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, $KA = $K.app, itemModel = null , key = '',
                ...
                $KU.each(data, function(data, counter) {
                    ...
                    $KW.iterate(itemModel, function(model, pmodel, index) {
                        var $K = kony.$kwebfw$, $KU = $K.utils,
                            _ = model._kwebfw_, dataId = '', defaultProp = null, prop = null;
                    ...
                    if(itemModel) {
                        ...
                        $KW.model($KA.currentFormUID).forceLayout();
                    }
                }, this);
        };
        ...
        var collectionview_removeAll = function CollectionView$removeAll(anim) {
            if(_animator.CollectionView.canAnimate.call(this, anim)) {
                _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.REMOVE, this._kwebfw_.items);
        ...
        var collectionview_setData = function CollectionView$setData(data, anim) {
            ...
            this.data = data;
            if(_animator.CollectionView.canAnimate.call(this, anim)) {
                _animator.CollectionView.onItemDisplayHandler.call(this, kony.segment.UPDATE, this._kwebfw_.items);
        ...
        var collectionview_setDataAt = function CollectionView$setDataAt(data, itemIndex, secIndex, anim, arg4) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, widget = null , key = '',
                _ = this._kwebfw_, prop = _.prop, old = null, errorMessage = null,
        ...
        $K.defKonyProp(CollectionView.prototype, [
