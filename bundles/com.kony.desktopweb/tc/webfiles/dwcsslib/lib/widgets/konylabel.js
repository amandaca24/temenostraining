...
(function() {
    ...
    var _deduceTagName = function Label$_deduceTagName() {
        var $K = kony.$kwebfw$, $KU = $K.utils, ariaLevel = -1,
            a11y = this._kwebfw_.prop.accessibilityConfig, tag = 'label';
        ...
        Label: function Label$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Label', null);
                }
            }
            if(!_.name) {
    ...
    var _valid = {
        Label: {
            ...
            textStyle: function Label$_valid_textStyle(value) {
                ...
                && (!value.hasOwnProperty('lineSpacing')
                    || ($KU.is(value.lineSpacing, 'integer')
                        && value.lineSpacing >= 0))
                && (!value.hasOwnProperty('letterSpacing')
        ...
        Label: {
            ...
            textStyle: function Label$_view_textStyle(el, old) {
                ...
                if(!value) {
                    ...
                    if(value.hasOwnProperty('lineSpacing')) {
                        if($KW.isRendered(this)) {
                            //Similar IF block can be found in konywidget.js file _onrender widget based function
                    ...
                    if(value.hasOwnProperty('letterSpacing')) {
    ...
    Object.defineProperty(kony.ui, 'Label', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Label constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Label>, but not in <_valid.Label> namespace.');
                        } else {
        ...
        $K.utils.inherits(Label, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.Label widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.Label
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – Label view.
         */
        var label__render = function Label$_render(tag) {
            var $super = kony.ui.Label.base.prototype, _ = this._kwebfw_,
                $K = kony.$kwebfw$, $KW = $K.widget, view = _.view, el = $KW.el(view);

            if(this.isVisible || $K.F.RIVW) {
                if(!view) {
                    view = $super._render.call(this, _deduceTagName.call(this));
                    el = $KW.el(view);
