...
/* global constants */
(function() {
    var $K = kony.$kwebfw$, _scriptsRequested = false;
    ...
    var _cachePinSizeAndSetupMarkers = function Map$_cachePinSizeAndSetupMarkers(imageObj, markerOptions) {
        var $K = kony.$kwebfw$, $KD = $K.dom, mapModel = this, img = null,
            imgName = null, anchorPosition = kony.map.PIN_IMG_ANCHOR_BOTTOM_CENTER,
    ...
    var _drawCircle = function Map$_drawCircle(circledt) {
        var $K = kony.$kwebfw$, $KU = $K.utils, lineColor = '#FF0000', _circle = null,
    ...
    var _drawPolygon = function Map$_drawPolygon(polygondt) {
        var $K = kony.$kwebfw$, $KU = $K.utils, polyGon = null,
    ...
    var _drawPolyline = function Map$_drawPolyline(polylinedata) {
        var $K = kony.$kwebfw$, $KU = $K.utils, polyLine = null,
    ...
    var _getPinAndIndexFromLocationData = function Map$_getPinAndIndexFromLocationData(pinId) {
        var $K = kony.$kwebfw$, $KU = $K.utils, output = null,
    ...
    var _getPolylinePinData = function Map$_getPolylinePinData(polylinedata) {
        var $K = kony.$kwebfw$, $KU = $K.utils, pindata = [],
    ...
    var _initializeInfoBox = function Map$_initializeInfoBox() {
        var $K = kony.$kwebfw$, $KU = $K.utils,
            $KD = $K.dom, $KG = $K.globals, src = null,
    ...
    var _loadMapScripts = function Map$_loadMapScripts() {
        ...
        || $KU.is(window.google.maps, 'undefined'))) {
            ...
            src = '//maps-api-ssl.google.com/maps/api/js?callback=kony.$kwebfw$.ui.Map.onLoad';
    ...
    var _mapClickEventHandler = function Map$_mapClickEventHandler(event) {
        var $K = kony.$kwebfw$, $KW = $K.widget, $KAR = $K.automation.recorder,
    ...
    var _markerClickListener = function Map$_markerClickListener(markerOptions) {
        ...
        return function() {
            var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom,
                $KU = $K.utils, infowindow = null, $KAR = $K.automation.recorder,
        ...
        Map: function Map$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Map', null);
                }
            }
            if(!_.name) {
    ...
    var _setPins = function Map$_setPins(mapData) {
        var $K = kony.$kwebfw$, $KU = $K.utils, pinIdsArr = [],
            locDataArr = this._kwebfw_.prop.locationData;
     ...
     * @memberof    kony.ui.Map
     * @author      Shanker Pulugam <shanker.pulugam@kony.com>
     *
     * @param       None
     *
    ...
    var _setUpInteractiveCanvasMap = function Map$_setUpInteractiveCanvasMap() {
        var $K = kony.$kwebfw$, $KU = $K.utils, _ = this._kwebfw_, prop = _.prop,
    ...
    Object.defineProperty(kony.ui, 'Map', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Map constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Map>, but not in <_valid.Map> namespace.');
                        } else {
        ...
        $K.utils.inherits(Map, kony.ui.BasicWidget);

        /**
         * Resets markers and  pinMarker to empty for kony.ui.Map widget.
         *
         * @override
         * @access      protected
         * @method      _flush
        ...
        var map__flush = function Map$_flush(tag) {
            var $super = kony.ui.Map.base.prototype,
                $K = kony.$kwebfw$, $KU = $K.utils;
        ...
        /**
         * Builds the view layer for kony.ui.Map widget.
         *
         * @override
         * @access      protected
         * @method      _render
        ...
        var map__render = function Map$_render(tag) {
            var $super = kony.ui.Map.base.prototype, _ = this._kwebfw_, el = null,
                $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, view = _.view;
        ...
        var map_dismissCallout = function Map$dismissCallout(location) {
            var $K = kony.$kwebfw$, $KU = $K.utils, pinId = null,
        ...
        var map_updatePin = function Map$updatePin(pindata) {
            var $K = kony.$kwebfw$, $KU = $K.utils, existingPindata = null,
        ...
        var map_removePin = function Map$removePin(pindata, delLocDataFlag) {
            var $K = kony.$kwebfw$, $KU = $K.utils, existingPindataObj = null,
        ...
        var map_navigateTo = function Map$navigateTo(index, showcallout) {
            var $K = kony.$kwebfw$, $KW = $K.widget, index = parseInt(index),
