...
(function() {
        ...
        RichText: function RichText$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.RichText', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'RichText', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.RichText constructor.
         *
         * @class
         * @namespace   kony.ui
         * @extends     kony.ui.BasicWidget
         * @author      Maruthi Doradla <maruthi.doradala@kony.com>
         *
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.RichText>, but not in <_valid.RichText> namespace.');
                        } else {
        ...
        $K.utils.inherits(RichText, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.RichText widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.RichText
         * @author      Maruthi Doradla <maruthi.doradala@kony.com>
         *
         * @returns     {HTMLElement} – RichText view.
         */
        var richtext__render = function RichText$_render(tag) {
            var $super = kony.ui.RichText.base.prototype,
        ...
        $K.defKonyProp(RichText.prototype, [
