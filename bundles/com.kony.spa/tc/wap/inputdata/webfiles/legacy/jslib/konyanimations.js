...
$KW.Animator.prototype = {
    ...
    animate: function(widgetModel, animationConfig, callBackConfig, context) {
        if(widgetModel) {
            ...
            if((widgetModel.isTemplate && widgetModel.containerType == 'CollectionView') || (widgetModel.parent.wType == "FlexContainer" || widgetModel.parent.wType == "FlexScrollContainer" || (widgetModel.parent.wType == 'Form' && widgetModel.parent.layouttype != kony.flex.VBOX_LAYOUT))) {
