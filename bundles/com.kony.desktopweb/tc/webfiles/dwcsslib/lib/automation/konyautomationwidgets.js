(function() {
    ...
    var flexcontainer_click = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.flexcontainer.click', enter:true});
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.flexcontainer.click VIA widget disabled or not visible');
            return;
        }

        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.flexcontainer.click VIA end of function', exit:true});
    ...
    var button_click = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.button.click', enter:true});
        if(arguments.length !== 1)
            $KAUtils.throwExceptionInsufficientArguments();
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.button.click VIA widget disabled or not visible');
            return;
        }

        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.button.click VIA end of function', exit:true});
        node && node.click();
    ...
    var textbox_enterText = function() {
        ...
        $KU.log({api:'kony.automation.textbox.enterText', enter:true});
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.textbox.enterText VIA widget disabled or not visible');
            return;
        }
        ...
        $KU.log({api:'kony.automation.textbox.enterText VIA end of function', exit:true});
    };

    var enterText_withDefaultEvent = function(widgetModel, item) {
        var $K = kony.$kwebfw$, node = null, $KD = $K.dom;
    ...
    var textarea_enterText = function(widgetPath, item) {
        ...
        $KU.log({api:'kony.automation.textarea.enterText', enter:true});
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.textarea.enterText VIA widget disabled or not visible');
            return;
        }
        ...
        $KU.log({api:'kony.automation.textarea.enterText VIA end of function', exit:true});
    ...
    var richtext_click = function(widgetPath, linktext) {
        ...
        $KU.log({api:'kony.automation.richtext.click', enter:true});
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log({api:'kony.automation.richtext.click VIA widget disabled or not visible', exit:true});
            return;
        }

        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.richtext.click VIA end of function', exit:true});
    ...
    var checkboxgroup_click = function(widgetPath, item) {
        ...
        $KU.log({api:'kony.automation.checkboxgroup.click', enter:true});
        if(arguments.length !== 2) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.checkboxgroup.click', exit:true});
        for(var i = 0; i < node.childElementCount; i++) {
    ...
    var radiobuttongroup_click = function(widgetPath, item) {
        ...
        $KU.log({api:'kony.automation.radiobuttongroup.click', enter:true});
        if(arguments.length !== 2)
            $KAUtils.throwExceptionInsufficientArguments();
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.radiobuttongroup.click VIA widget disabled or not visible');
            return;
        }
        node = widgetModel._kwebfw_.view;

        $KU.log({api:'kony.automation.radiobuttongroup.click VIA end of function', exit:true});
        for(var i = 0; i < node.childElementCount; i++) {
            if(item.indexOf(node.children[i].children[0].value) > -1) {
                node.children[i].children[0].click();
            }
    ...
    var listbox_selectItem = function(widgetPath, item) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
           ...
           $KU.log({api:'kony.automation.listbox.selectItem', enter: true});
            if(arguments.length !== 2) {
                $KAUtils.throwExceptionInsufficientArguments();
            }
            ...
            if(!$KAUtils.isEventApplicable(widgetModel)) {
                $KU.log('kony.automation.listbox.selectItem VIA widget disabled or not visible');
                return;
            }

            node = widgetModel._kwebfw_.view;
            $KU.log({api: 'kony.automation.listbox.selectItem VIA end of function', exit: true});
    ...
    var switch_toggle = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.switch.toggle', enter: true});
        if(arguments.length !== 1) {
            $KAUtils.throwExceptionInsufficientArguments();
        }

        //$KU.log('kony.automation.switch.toggle', widgetPath);
        if(!$KU.is(widgetPath, 'array')) {
            $KAUtils.throwExceptionInvalidArgumentType();
        }
        ...
        $KU.log({api:'kony.automation.switch.toggle', exit: true});
    ...
    var calendar_selectDate = function(widgetPath, date) {
        ...
        $KU.log({api: 'kony.automation.calendar.selectDate', enter: true});
        if(arguments.length !== 2) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        $KU.log({api: 'kony.automation.calendar.selectDate', exit: true});
        node && node.click();
    ...
    var datagrid_click = function(widgetPath, item) {
        ...
        $KU.log({api:'kony.automation.datagrid.click', enter: true });
        if(arguments.length !== 2) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        //$KU.log('kony.automation.datagrid.click', widgetPath, item);
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.datagrid.click VIA widget disabled or not visible');
            return;
        }

        node = widgetModel._kwebfw_.view
        $KU.log({api:'kony.automation.datagrid.click VIA end of function', exit: true});
        if(item.row == -1) {
    ...
    var segmentedui_click = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.segmentedui.click ', enter: true});
        if(arguments.length !== 1) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        if(!$KAUtils.isEventApplicable(widgetModel)) {
            $KU.log('kony.automation.segmentedui.click VIA widget disabled or not visible');
            return;
        }

        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.segmentedui.click ', exit: true});
        node && node.click();
    ...
    var segmentedui_getItem = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.segmentedui.getItem ', enter: true});
        if(arguments.length !== 1) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        $KU.log({api:'kony.automation.segmentedui.getItem ', exit: true});
        return widgetModel;
    };
    ...
    var segmentedui_scrollToBottom = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.segmentedui.scrollToBottom ', enter: true});
        ...
        $KU.log({api:'kony.automation.segmentedui.scrollToBottom ', exit: true});
    };
    ...
    var segmentedui_scrollToRow = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.segmentedui.scrollToRow ', enter: true});
        ...
        $KU.log({api:'kony.automation.segmentedui.scrollToRow ', exit: true});
    ...
    var segmentedui_scrollToTop = function(widgetPath) {
        ...
        $KU.log({api:'kony.automation.segmentedui.scrollToTop ', enter: true});
        ...
        node = widgetModel._kwebfw_.view;
        node.scrollTop = 0;
        $KU.log({api:'kony.automation.segmentedui.scrollToTop ', exit: true});
    };
    ...
    var tabpane_click = function(widgetPath, tabHeader) {
        ...
        $KU.log({api:'kony.automation.tabpane.click', enter: true});
        if(arguments.length !== 2) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        $KU.log({api:'kony.automation.tabpane.click', exit: true});
        if(tabs.length) {
    ...
    var slider_slide = function(widgetPath, value) {
        ...
        $KU.log({api:'kony.automation.slider.slide', enter: true});
        if(arguments.length !== 2) {
            $KAUtils.throwExceptionInsufficientArguments();
        }
        ...
        node = widgetModel._kwebfw_.view;
        $KU.log({api:'kony.automation.slider.slide', exit: true});
