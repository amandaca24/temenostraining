...
(function() {
    ...
    $K.defKonyProp($K.ui, [
        {keey:'FlexScrollContainer', value:{}, items:[
        ...
        FlexScrollContainer: function FlexScrollContainer$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.FlexScrollContainer', true);
                }
            }
            if(!_.name) {
    ...
    var _valid = {
        FlexScrollContainer: {
            ...
            contentOffsetMeasured: function FlexScrollContainer$_valid_contentOffsetMeasured() {
                var $K = kony.$kwebfw$, $KU = $K.utils, flag = false;
    ...
    Object.defineProperty(kony.ui, 'FlexScrollContainer', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.FlexScrollContainer constructor.
         *
         * @class
         * @namespace   kony.ui
         * @extends     kony.ui.FlexContainer
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.FlexScrollContainer>, but not in <_valid.FlexScrollContainer> namespace.');
                        } else {
        ...
        $K.utils.inherits(FlexScrollContainer, kony.ui.FlexContainer);
         ...
         * @access      protected
         * @method      _flush
         * @memberof    kony.ui.FlexScrollContainer
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     void
         */
        var flexscrollcontainer__flush = function FlexScrollContainer$_flush(config) {
            var $super = kony.ui.FlexScrollContainer.base.prototype,
        ...
        var flexscrollcontainer_setZoomScale = function FlexScrollContainer$setZoomScale() {
            ...
            $KU.unsupportedAPI('kony.ui.FlexScrollContainer.setZoomScale');
        };


        $K.defKonyProp(FlexScrollContainer.prototype, [
