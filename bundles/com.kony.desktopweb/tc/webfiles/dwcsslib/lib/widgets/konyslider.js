...
(function() {
        ...
        {keey:'Slider', value:{}, items:[
            ...
            {keey:'onKeyDown', value:function(evt) {
                ...
                && prop.orientation === constants.SLIDER_HORIZONTAL_ORIENTATION) {
                    ...
                    if(!_.ui.hasOwnProperty('keydown')) {
                        _.ui.keydown = true;
    ...
    var _dependentPropertiesValidationMessage = {
        Slider: function Slider$_dependentPropertiesValidationMessage(prop, bconfig, lconfig, pspconfig) {
            var $K = kony.$kwebfw$, $KU = $K.utils, message = '',
        ...
        Slider: function Slider$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Slider', null);
                }
            }
            if(!_.name) {
    ...
    var _registerSlideGesture = function Slider$_registerSlideGesture(thumb) {
        ...
        $KD.on(thumb, 'basic', 'slider', function(g) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
                ...
                el = $KW.el(this), moved = false, percent = 0, value = 0;
            ...
            if(g.delta.x && prop.orientation === constants.SLIDER_HORIZONTAL_ORIENTATION) {
                moved = true;
                percent = ((100/_.ui.size) * g.delta.x);
    ...
    var _valid = {
        Slider: {
            ...
            max: function Slider$_valid_max(value) {
                ...
                if(flag && prop.hasOwnProperty('min') && prop.hasOwnProperty('selectedValue')) {
            ...
            min: function Slider$_valid_min(value) {
                ...
                if(flag && prop.hasOwnProperty('max') && prop.hasOwnProperty('selectedValue')) {
            ...
            selectedValue: function Slider$_valid_selectedValue(value) {
                ...
                if(flag && prop.hasOwnProperty('min') && prop.hasOwnProperty('max')) {
    ...
    var _view = {
        Slider: {
            ...
            selectedValue: function Slider$_view_selectedValue(el, old) {
                var $K = kony.$kwebfw$, $KD = $K.dom, min = this.min,
                    value = this.selectedValue, percent = 0, max = this.max;

                this._kwebfw_.percent = percent = ((100 / (max - min)) * (value - min));
    ...
    Object.defineProperty(kony.ui, 'Slider', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Slider constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Slider>, but not in <_valid.Slider> namespace.');
                        } else {
        ...
        $K.utils.inherits(Slider, kony.ui.BasicWidget);
         ...
         * @access      protected
         * @method      _flush
         * @memberof    kony.ui.Slider
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     void
         */
        var slider__flush = function Slider$_flush() {
            var $super = kony.ui.Slider.base.prototype,
        ...
        /**
         * Builds the view layer for kony.ui.Slider widget.
         *
         * @override
         * @access      protected
         * @method      _render
        ...
        var slider__render = function Slider$_render(tag) {
            var $super = kony.ui.Slider.base.prototype, _ = this._kwebfw_,
                view = _.view, min = null, $K = kony.$kwebfw$, $KW = $K.widget,
        ...
        $K.defKonyProp(Slider.prototype, [
