kony.nosql = (function() {
    ...
    var indexedDB = {
        ...
        createIndices: function(databaseObject, tableName, indexes) {
            $KU.logExecuting('kony.nosql.createIndices');
            $KU.logExecutingWithParams('kony.nosql.createIndices', databaseObject, tableName);
            return new Promise(function(resolve, reject) {
                ...
                transaction.oncomplete = function(e){
                    kony.web.logger('log', 'transaction completed in createIndices');
                    resolve(true);
                }
        ...
        deleteIndices: function(databaseObject, tableName, indexes) {
            $KU.logExecuting('kony.nosql.deleteIndices');
            $KU.logExecutingWithParams('kony.nosql.deleteIndices', databaseObject, tableName);
            return new Promise(function(resolve, reject) {
                ...
                transaction.oncomplete = function(e){
                    kony.web.logger('log', 'transaction completed in deleteIndices');
                    resolve(true);
                }
            });
        }
