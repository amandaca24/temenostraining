...
(function() {
        ...
        CustomWidget: function CustomWidget$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.CustomWidget', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'CustomWidget', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.CustomWidget constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(dependentPropertiesValidationMessage) {
                    ...
                    if(!bconfig.isPreValidated) {
                        ...
                        $KU.each(prop, function (value, key) {
                            ...
                            if(!bconfig.hasOwnProperty(key)) {
                                ...
                                throw new Error('<' + key + '> is available in default widget properties of <kony.ui.CustomWidget>, but not in <_valid.CustomWidget> namespace.');
                            } else {
                    ...
                    $KU.each(_view.CustomWidget, function(value, key) {
                        ...
                        $KU.defineSetter(self, key, function CustomWidget$_setter(val) {
                            var $K = kony.$kwebfw$, $KU = $K.utils, old = null, valid = false,
        ...
        $K.utils.inherits(CustomWidget, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.CustomWidget widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.CustomWidget
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – CustomWidget view.
         */
        var custom__render = function CustomWidget$_render(tag) {
            var $super = kony.ui.CustomWidget.base.prototype, _ = this._kwebfw_,
        ...
        $K.defKonyProp(CustomWidget.prototype, [
