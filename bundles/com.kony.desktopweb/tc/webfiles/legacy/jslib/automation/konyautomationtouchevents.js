...
kony.automation.playback = (function() {
    ...
    var _waitForElement = function(widgetPath, timeOut, resolve, reject) {
        ...
        setTimeout(function() {
            ...
            if(id.split('/').length > 1){
                id = id.split('/');
                if($KG.appbehaviors['isCompositeApp'] == true && id[0] !== _kony.mvc.getCurrentAppName()) {
    ...
    module.waitForLoadingScreenToDismiss = function(timeout) {
        ...
        $KU.logExecuting({api:'kony.automation.waitForLoadingScreenToDismiss', enter:true});
        if(timeout && typeof timeout !== 'number') {
            $KAUtils.throwExceptionInvalidArgumentType();
        }
    
        $KU.logExecutingFinished({api:'kony.automation.waitForLoadingScreenToDismiss', exit:true});
        return new Promise(function(resolve, reject) {
                  _waitOnLoadingScreen(timeout, resolve, reject);
              });
    }
...
kony.automation.captureAsBase64 = function(){
...
kony.automation.getParentInfo = function() {
    var result = {};
...
kony.automation.launchApp = function(config) {
...
kony.automation.waitForEvent = function(options) {
...
kony.automation.sendEvent = function(targetDetails) {
...
kony.automation.sendEventToParent = function(targetDetails) {
    var targetWindow = null, parentAppURL = "", parentApp = _kony.automation.parentApp;
...
kony.automation.webSocket = (function(){
    var module = {};
