...
(function (ns) {
    ...
    ns.getCSSFileName = function(platform, category) {
        var foldernames = {
            'spaip' : 'konyspaiphone',
            'spaan' : 'konyspaandroid',
            'spabb' : 'konyspabb',
            'spawinphone8' : 'konyspawindows',
            'spabbnth' : 'konyspabbnth',
            'spawindows' : 'spawindows',
            'spaipad' : 'konyspatabletiphone',
            'spaandroidtablet' : 'konyspatabletandroid',
            'spawindowstablet' : 'konyspawindowstablet',
            'desktopweb' : 'kony',
            'desktopwebcommon' : 'konydesktop'
        };
