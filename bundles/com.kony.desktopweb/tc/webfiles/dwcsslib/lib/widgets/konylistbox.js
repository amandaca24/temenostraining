...
/* global constants */
(function() {
    var $K = kony.$kwebfw$, _renderListBox = {};
    ...
    $K.defKonyProp($K.ui, [
        {keey:'ListBox', value:{}, items:[
            ...
            {keey:'onIconKeyUp', value:function(evt) {
                var $K = kony.$kwebfw$, $KD = $K.dom, _ = this._kwebfw_, $KW = $K.widget,
            ...
            {keey:'onInputKeyUp', value:function(evt) {
                var $K = kony.$kwebfw$, $KD = $K.dom, _ = this._kwebfw_, $KW = $K.widget, $KU = $K.utils,
    ...
    var _applySkinOnListItem = function ListBox$_applySkinOnListItem(prop, option) {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom, disabledkeys = prop.disabledKeys || [],
        itemNormalSkin = prop.itemNormalSkin, itemDisabledSkin = prop.itemDisabledSkin || '-kony-option-disabled';
        ...
        if(disabledkeys.length !== 0 && disabledkeys.indexOf(option.getAttribute('value')) !== -1) {
            ...
            if(itemDisabledSkin === '-kony-option-disabled') {
    ...
    var _closePicker = function ListBox$_closePicker() {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
            $KD = $K.dom, _ = this._kwebfw_, fmodel = null, el = null;
    ...
    var _dependentPropertiesValidationMessage = {
        ListBox: function ListBox$_dependentPropertiesValidationMessage(prop, bconfig, lconfig, pspconfig) {
            var $K = kony.$kwebfw$, $KU = $K.utils, message = '', keys = [],
            ...
            masterDataMap: function ListBox$_getter_masterDataMap(value) {
                ...
                if(value) {
                    ...
                    $KU.each(value[0], function(item) {
                        var $K = kony.$kwebfw$, $KU = $K.utils, val = {};
                        ...
                        && val[valName].toLowerCase().indexOf('kony.i18n.getlocalizedstring') !== -1) {
    ...
    var _getValueByKey = function ListBox$_getValueByKey(ki) {
        var $K = kony.$kwebfw$, $KU = $K.utils, value = '', k = '', v = '',
    ...
    var _openPicker = function ListBox$_openPicker() {
        var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
            $KD = $K.dom, _ = this._kwebfw_, fmodel = null,
            el = null, pel = null;
        ...
        ListBox: function ListBox$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.ListBox', null);
                }
            }
            if(!_.name) {
    ...
    _renderListBox[constants.LISTBOX_VIEW_TYPE_LISTVIEW] = function ListBox$_renderListBox_listview() {
        ...
        $KW = $K.widget, $super = kony.ui.ListBox.base.prototype,
        ...
        if(view) {
            ...
            $KU.each(masterdata, function(data) {
                var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom, key = '',
    ...
    var _setter = {
        ListBox: {
            multiSelect: function ListBox$_setter_multiSelect(old) {
                var $K = kony.$kwebfw$, prop = this._kwebfw_.prop, count = -1;
            ...
            selectedKey: function ListBox$_setter_selectedKey(old) {
                var $K = kony.$kwebfw$, $KU = $K.utils, $KD = $K.dom,
                $KW = $K.widget, prop = this._kwebfw_.prop, index = -1,
    ...
    var _updateDisableItemOption = function ListBox$_updateDisableItemOption(li, code) {
        var $K = kony.$kwebfw$, $KD = $K.dom, _ = this._kwebfw_, prop = _.prop,
        ...
        ListBox: {
            ...
            disabledKeys: function ListBox$_valid_disabledKeys(value) {
                ...
                if($KU.is(value, 'null')) {
                    ...
                    if(flag && value) {
                        if((prop.hasOwnProperty('masterData') && prop.masterData)
                        ||  (prop.hasOwnProperty('masterDataMap') && prop.masterDataMap)) {
            ...
            selectedKey: function ListBox$_valid_selectedKey(value) {
                ...
                && prop.hasOwnProperty('masterData')
                && prop.hasOwnProperty('masterDataMap')) {
            ...
            selectedKeys: function ListBox$_valid_selectedKeys(value) {
                ...
                if($KU.is(value, 'null')) {
                    ...
                    if(prop.hasOwnProperty('multiSelect') && !prop.multiSelect && value.length > 1) {
                        flag = false;
                    }
    ...
    var _view = {
        ListBox: {
            ...
            viewType: function ListBox$_view_viewType(el, old) {
                var $K = kony.$kwebfw$, $KW = $K.widget, $KD = $K.dom, view = null,
    ...
    Object.defineProperty(kony.ui, 'ListBox', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
        * kony.ui.ListBox constructor.
        *
        * @class
        * @namespace   kony.ui
        ...
        */
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.ListBox>, but not in <_valid.ListBox> namespace.');
                        } else {
        ...
        $K.utils.inherits(ListBox, kony.ui.GroupWidget);


        /**
        * Builds the view layer for kony.ui.ListBox widget.
        *
        * @override
        * @access      protected
        * @method      _render
        * @memberof    kony.ui.ListBox
        * @author      Goutam Sahu <goutam.sahu@kony.com>
        *
        ...
        */
        ...
        var listbox_setFocus = function ListBox$_setFocus(value) {
            var $super = kony.ui.ListBox.base.prototype, $K = kony.$kwebfw$,
        ...
        $K.defKonyProp(ListBox.prototype, [
