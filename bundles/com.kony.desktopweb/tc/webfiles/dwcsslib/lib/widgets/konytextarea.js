...
(function() {
        ...
        TextArea2: function TextArea2$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.TextArea2', null);
                }
            }
            if(!_.name) {
    ...
    var _valid = {
        TextArea2: {
            ...
            numberOfVisibleLines: function TextArea2$_valid_numberOfVisibleLines(value) {
                var $K = kony.$kwebfw$, $KU = $K.utils, flag = false;
    ...
    var _view = {
        TextArea2: {
            autoCapitalize: function TextArea2$_view_autoCapitalize(el, old) {
                var $K = kony.$kwebfw$, $KD = $K.dom, value = '';
            ...
            numberOfVisibleLines: function TextArea2$_view_numberOfVisibleLines(el, old) {
                var $K = kony.$kwebfw$, $KD = $K.dom;

                if(this.numberOfVisibleLines === '') {
                    $KD.removeAttr(el.node, 'rows');
                } else {
                    $KD.setAttr(el.node, 'rows', this.numberOfVisibleLines);
                }
            },
    ...
    Object.defineProperty(kony.ui, 'TextArea2', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.TextArea2 constructor.
         *
         * @class
         * @namespace   kony.ui
            ...
            if(dependentPropertiesValidationMessage) {
                ...
                $KU.each(prop, function(value, key) {
                    ...
                    if(!bconfig.hasOwnProperty(key)) {
                        ...
                        throw new Error('<'+key+'> is available in default widget properties of <kony.ui.TextArea2>, but not in <_valid.TextArea2> namespace.');
                    } else {
        ...
        $K.utils.inherits(TextArea2, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.TextArea2 widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.TextArea2
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – TextArea2 view.
         */
        var textarea2__render = function TextArea2$_render(tag) {
            var $super = kony.ui.TextArea2.base.prototype,
                _ = this._kwebfw_, view = _.view, $K = kony.$kwebfw$,
            ...
            if(this.isVisible || $K.F.RIVW) {
                if(!view) {
                    ...
                    $KD.setAttr(view, 'autocomplete', (this.autoComplete ? 'on' : 'off'));
                    ...
                    _view.TextArea2.numberOfVisibleLines.call(this, el, this.numberOfVisibleLines);
        ...
        var textarea2_getSelection = function TextArea2$getSelection() {
            return kony.ui.TextBox2.prototype.getSelection.call(this);
        };


        var textarea2_setFocus = function TextArea2$setFocus(value) {
            kony.ui.TextBox2.prototype.setFocus.call(this, value);
        };


        var textarea2_setSelection = function TextArea2$setSelection(startIndex, endIndex) {
            kony.ui.TextBox2.prototype.setSelection.call(this, startIndex, endIndex);
        };


        $K.defKonyProp(TextArea2.prototype, [
