...
(function (ns) {
    ...
    */
    ...
    ns.processBackGroundProperties = function(skin, styleMap, platform) {
        try{
            ...
            if(backgroundstyle && backgroundstyle == "one") {
                ...
                if(platform == "desktopwebcommon") {
                    ...
                    msgString = msgString.replace(/,\s*$/, "");
                    msgString = konyutil.removeTrailingComma(msgString);
                    styleMap["background-ms-color"] = msgString;
                } else {
                    msgString = angle_msg+",";
                    for(var i = 0; i < colors_msg.length && i < percent_msg.length; i++) {
                    ...
                    if(platform == 'spawinphone8' || platform == 'spawindowstablet') {
                        ...
                        skinAttrbNew = konyutil.removeTrailingComma(skinAttrbDeg.concat(skinAttrbNew));
                        ...
                        skinAttrbNew = konyutil.removeTrailingComma(skinAttrbNew);
    ...
    ns.processBorderProperties = function(skin, styleMap, platform) {
