(function() {
    ...
    var _drawLine = function Canvas$_drawLine(ctx, shape) {
        ...
        if(points && points.length === 2) {
            ...
            ctx.beginPath();
            if(kony.canvas.LINE_STYLE_DASHED === shape.lineStyle
            || kony.canvas.LINE_STYLE_DOTTED === shape.lineStyle) {
                if(lineConfig) {
            ...
            *
            ...
            } else if(kony.canvas.LINE_STYLE_DOTTED === shape.lineStyle) {
               ctx.lineCap   = 'round';
            }
            */
    ...
    var _drawShapesOnCanvas = function Canvas$_drawShapesOnCanvas() {
        var $K = kony.$kwebfw$, $KW = $K.widget, $KU = $K.utils,
            ...
            el = $KW.el(this), len = 0,  scale = $K.device.DPI,
        ...
        $KU.each(shapesdata, function(shape, index) {
            if(kony.canvas.SHAPE_TYPE_LINE === shape.shapeType) {
    ...
    var _getDataObj = function Canvas$_getDataObj(dataArr) {
        var $K = kony.$kwebfw$, $KU = $K.utils, returnDataObj = {};
    ...
    var _getIndexFromShapesData = function Canvas$_getIndexFromShapesData(shapeId) {
        var $K = kony.$kwebfw$, $KU = $K.utils, returnIndex = -1,
    ...
    var _getStrokeStyleTwoStepGradient = function Canvas$_getStrokeStyleTwoStepGradient(ctx, strokeColor, points, lineThickness) {
        var $K = kony.$kwebfw$, $KU = $K.utils, bottomcolor = '',
    ...
    var _getStrokeStyleMSGradient = function(ctx, strokeColor, points, lineThickness) {
        var $K = kony.$kwebfw$, $KU = $K.utils, gradient = null,
        ...
        Canvas: function Canvas$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Canvas', null);
                }
            }
            if(!_.name) {
   ...
   var _relayoutPassiveTriggerer = {
    ...
    var _updateShapeData = function Canvas$_updateShapeData(shapeData) {
        var $K = kony.$kwebfw$, $KU = $K.utils, returnflag = false,
        ...
        if(index !== -1) {
            ...
            if(kony.canvas.SHAPE_TYPE_LINE === updateData.shapeType) {
                ...
                if($KU.is(value, 'array')) {
                    $KU.each(value, function(data, index) {
                        ...
                        if(!data.shapeid) {
                            ...
                            throw new $KU.error(6002, 'Invalid shapesData', 'shapesData has duplicate shape identifier. ' + dataArr[i].shapeid);
                        } else {
                            if(kony.canvas.SHAPE_TYPE_LINE === data.shapeType) {
    ...
    Object.defineProperty(kony.ui, 'Canvas', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Canvas constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Canvas>, but not in <_valid.Canvas> namespace.');
                        } else {
        ...
        $K.utils.inherits(Canvas, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.Canvas widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.Canvas
         * @author      Shanker Pulugam <shanker.pulugam@kony.com>
         *
         * @returns     {HTMLElement} – Canvas view.
         */
        var canvas__render = function Canvas$_render(tag) {
            var $super = kony.ui.Canvas.base.prototype,
        ...
        var canvas_addShapes = function Canvas$addShapes(shapesData) {
            var $K = kony.$kwebfw$, $KW = $K.widget, final = null,
                hmodel = null, rmodel = null, omodel = null, $KU = $K.utils,
        ...
        var canvas_removeShapes = function Canvas$removeShapes(shapeIds) {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget, final = null,
                isremoved = false, hmodel = null, rmodel = null, omodel = null;
        ...
        var canvas_updateShapes = function Canvas$updateShapes(shapesData) {
            var $K = kony.$kwebfw$, $KW = $K.widget, final = null, isupdated = false,
                hmodel = null, rmodel = null, omodel = null, $KU = $K.utils;
        ...
        $K.defKonyProp(Canvas.prototype, [
