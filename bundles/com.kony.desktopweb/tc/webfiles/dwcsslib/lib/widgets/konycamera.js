(function() {
        ...
        {keey:'Camera', value:{}, items:[
            ...
            {keey:'setupUIInteraction', value:function(dom, clone) {
                ...
                if(!$KW.interactable(this)) {
                    ...
                    $KD.addCls(this._kwebfw_.view, '-kony-blocker');
                } else {
                    tabindex = $KW.tabIndex(this, clone);
                    $KD.removeAttr(dom, 'aria-disabled');
                    $KD.removeCls(this._kwebfw_.view, '-kony-blocker');
        ...
        Camera: function Camera$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Camera', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'Camera', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Camera constructor.
         *
         * @class
         * @namespace   kony.ui
         * @extends     kony.ui.BasicWidget
         * @author      Kasam SaiTeja <saiteja.kasam@kony.com>
         *
         ...
         */
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Camera>, but not in <_valid.Camera> namespace.');
                        } else {
                ...
                $KU.each(_view.Camera, function(value, key) {
                    ...
                    $KU.defineSetter(self, key, function Camera$_setter(val) {
                        var $K = kony.$kwebfw$, $KU = $K.utils, old = null,
                            valid = false, $KW = $K.widget, old = null, rmodel = null,
         ...
         $K.utils.inherits(Camera, kony.ui.BasicWidget);

         /**
         * Builds the view layer for kony.ui.Camera widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.Camera
         * @author      Kasam SaiTeja <saiteja.kasam@kony.com>
         *
         ...
         */
         ...
         var camera__render = function Camera$_render(tag) {
            var $super = kony.ui.Camera.base.prototype, _ = this._kwebfw_,
                $K = kony.$kwebfw$, $KD = $K.dom, $KW = $K.widget,
        ...
        var camera_takePicture = function Camera$takePicture() {
            var $K = kony.$kwebfw$, $KU = $K.utils, $KW = $K.widget,
                $KD = $K.dom, el = $KW.el(this), imgCanvas = null,
                context = null, _ = this._kwebfw_, canvasHeight = null,
                canvasWidth = null;
        ...
        $K.defKonyProp(Camera.prototype, [
