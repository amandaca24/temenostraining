...
(function() {
        ...
        Switch: function Switch$_populateUnderscore() {
            ...
            if(!_.ns) {
                if($KU.is(this.__$kwebfw$ns__, 'string') && this.__$kwebfw$ns__) {
                    ...
                    $KU.defineProperty(_, 'ns', 'kony.ui.Switch', null);
                }
            }
            if(!_.name) {
    ...
    Object.defineProperty(kony.ui, 'Switch', {configurable:false, enumerable:false, writable:false, value:(function() {
        var $K = kony.$kwebfw$;


        /**
         * kony.ui.Switch constructor.
         *
         * @class
         * @namespace   kony.ui
                ...
                if(!bconfig.isPreValidated) {
                    ...
                    $KU.each(prop, function (value, key) {
                        ...
                        if(!bconfig.hasOwnProperty(key)) {
                            ...
                            throw new Error('<' + key + '> is available in default widget properties of <kony.ui.Switch>, but not in <_valid.Switch> namespace.');
                        } else {
        ...
        $K.utils.inherits(Switch, kony.ui.BasicWidget);


        /**
         * Builds the view layer for kony.ui.Switch widget.
         *
         * @override
         * @access      protected
         * @method      _render
         * @memberof    kony.ui.Switch
         * @author      Goutam Sahu <goutam.sahu@kony.com>
         *
         * @returns     {HTMLElement} – Switch view.
         */
        var switch__render = function Switch$_render(tag) {
            var $super = kony.ui.Switch.base.prototype, _ = this._kwebfw_,
                left = null, view = _.view, $K = kony.$kwebfw$,
        ...
        $K.defKonyProp(Switch.prototype, [
