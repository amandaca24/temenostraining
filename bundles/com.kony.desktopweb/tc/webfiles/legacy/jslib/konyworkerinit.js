...
tobeimplemented = function() {
    kony.print('to be implemented', 'warn');
}
...
onmessage = function(oEvent) {
    ...
    if(PUBLISH) {
        ...
        importScripts('konytimerapi.js', 'konyconstants.js', 'konyosapi.js', 'konysystem.js', 'konynetwork.js');
        importScripts('konyworker.js', 'konydatabaseapi.js', 'konycrypto.js', 'tparty/crypto/cryptojslib.js');
        if(data.isFMSupported) {
            importScripts('konyFunctionalModules.js', 'konymodule.js', 'tparty/requirejs/require.js');
        }
    }
